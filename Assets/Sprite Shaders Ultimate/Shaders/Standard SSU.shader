...
Shader "Sprite Shaders Ultimate/Standard SSU"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			float MyCustomExpression16_g11897( float linValue )
			{
			...
			float MyCustomExpression16_g11895( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g11926( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12111( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12093( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12088( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12082( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12114( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float2 MyCustomExpression10_g12129( float2 UV, int Width, int Height, float Tile, float2 Invert )
			{
			...
			float2 MyCustomExpression10_g12125( float2 UV, int Width, int Height, float Tile, float2 Invert )
			{
				Tile = fmod(Tile + 0.001, Width * Height);
				float2 tileCount = float2(1, 1) / float2(Width, Height);
				float tileY = abs(Invert.y * Height - (floor(Tile * tileCount.x) + Invert.y * 1));
			...
			float MyCustomExpression16_g12136( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12144( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12146( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12142( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12138( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g12140( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			v2f vert( appdata_t IN  )
			{
				...
				float2 break77_g12162 = fixedUV475;
				float2 appendResult72_g12162 = (float2(( _SquishStretch * ( break77_g12162.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g12162.y + _SquishFlip ) * -_SquishSquish )));
				#ifdef _ENABLESQUISH_ON
				float2 staticSwitch198 = ( appendResult72_g12162 + _ZeroVector );
				#else
				float2 staticSwitch198 = _ZeroVector;
				#endif
				float2 temp_output_2_0_g12164 = staticSwitch198;
				#ifdef _TOGGLECUSTOMTIME_ON
				float staticSwitch44_g11899 = _TimeValue;
				#else
				float staticSwitch44_g11899 = _Time.y;
				#endif
				#ifdef _TOGGLEUNSCALEDTIME_ON
				float staticSwitch34_g11899 = UnscaledTime;
				#else
				float staticSwitch34_g11899 = staticSwitch44_g11899;
				#endif
				#ifdef _TOGGLETIMESPEED_ON
				float staticSwitch37_g11899 = ( staticSwitch34_g11899 * _TimeSpeed );
				#else
				float staticSwitch37_g11899 = staticSwitch34_g11899;
				#endif
				#ifdef _TOGGLETIMEFPS_ON
				float staticSwitch38_g11899 = ( floor( ( staticSwitch37_g11899 * _TimeFPS ) ) / _TimeFPS );
				#else
				float staticSwitch38_g11899 = staticSwitch37_g11899;
				#endif
				#ifdef _TOGGLETIMEFREQUENCY_ON
				float staticSwitch42_g11899 = ( ( sin( ( staticSwitch38_g11899 * _TimeFrequency ) ) * _TimeRange ) + 100.0 );
				#else
				float staticSwitch42_g11899 = staticSwitch38_g11899;
				#endif
				float shaderTime237 = staticSwitch42_g11899;
				float temp_output_8_0_g12164 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g12164 = ( ( sin( ( temp_output_8_0_g12164 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g12164 );
				#else
				float2 staticSwitch4_g12164 = temp_output_2_0_g12164;
				#endif
				float temp_output_30_0_g12165 = temp_output_8_0_g12164;
				float3 rotatedValue21_g12165 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g12165 * _VibrateRotation ) );
				#ifdef _ENABLEVIBRATE_ON
				float2 staticSwitch6_g12164 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g12165 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g12165).xy ) + staticSwitch4_g12164 );
				#else
				float2 staticSwitch6_g12164 = staticSwitch4_g12164;
				#endif
				#ifdef _ENABLESINESCALE_ON
				float2 staticSwitch10_g12164 = ( staticSwitch6_g12164 + ( (IN.vertex.xyz).xy * ( ( ( sin( ( _SineScaleFrequency * temp_output_8_0_g12164 ) ) + 1.0 ) * 0.5 ) * _SineScaleFactor ) ) );
				#else
				float2 staticSwitch10_g12164 = staticSwitch6_g12164;
				#endif
				float2 temp_output_424_0 = staticSwitch10_g12164;
				float2 uv_FadingMask = IN.texcoord.xy * _FadingMask_ST.xy + _FadingMask_ST.zw;
				float4 tex2DNode3_g11898 = tex2Dlod( _FadingMask, float4( uv_FadingMask, 0, 0.0) );
				float temp_output_4_0_g11896 = max( _FadingWidth , 0.001 );
				...
				#endif
				float2 temp_output_61_0_g11900 = staticSwitch437;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float2 texCoord23_g11900 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult28_g11900 = (float2(_RectWidth , _RectHeight));
				#if defined( _SHADERSPACE_UV )
				float2 staticSwitch1_g11900 = ( temp_output_61_0_g11900 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#elif defined( _SHADERSPACE_UV_RAW )
				float2 staticSwitch1_g11900 = temp_output_61_0_g11900;
				#elif defined( _SHADERSPACE_OBJECT )
				float2 staticSwitch1_g11900 = (IN.vertex.xyz).xy;
				#elif defined( _SHADERSPACE_OBJECT_SCALED )
				float2 staticSwitch1_g11900 = ( (IN.vertex.xyz).xy * (ase_objectScale).xy );
				#elif defined( _SHADERSPACE_WORLD )
				float2 staticSwitch1_g11900 = (ase_positionWS).xy;
				#elif defined( _SHADERSPACE_UI_GRAPHIC )
				float2 staticSwitch1_g11900 = ( texCoord23_g11900 * ( appendResult28_g11900 / _PixelsPerUnit ) );
				#elif defined( _SHADERSPACE_SCREEN )
				float2 staticSwitch1_g11900 = ( ( (ase_positionSSNorm).xy * (_ScreenParams).xy ) / ( _ScreenParams.x / _ScreenWidthUnits ) );
				#else
				float2 staticSwitch1_g11900 = ( temp_output_61_0_g11900 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#endif
				float2 temp_output_70_0_g11900 = ( _ShaderSpaceOffset + staticSwitch1_g11900 );
				#ifdef _SHADERSPACEPIXELATE_ON
				float2 staticSwitch63_g11900 = ( floor( ( temp_output_70_0_g11900 * _ShaderSpacePixelation ) ) / _ShaderSpacePixelation );
				#else
				float2 staticSwitch63_g11900 = temp_output_70_0_g11900;
				#endif
				float2 shaderPosition235 = staticSwitch63_g11900;
				float linValue16_g11897 = tex2Dlod( _UberNoiseTexture, float4( ( shaderPosition235 * _FadingNoiseScale ), 0, 0.0) ).r;
				float localMyCustomExpression16_g11897 = MyCustomExpression16_g11897( linValue16_g11897 );
				float clampResult14_g11896 = clamp( ( ( ( _FadingFade * ( 1.0 + temp_output_4_0_g11896 ) ) - localMyCustomExpression16_g11897 ) / temp_output_4_0_g11896 ) , 0.0 , 1.0 );
				float2 temp_output_27_0_g11894 = shaderPosition235;
				float linValue16_g11895 = tex2Dlod( _UberNoiseTexture, float4( ( temp_output_27_0_g11894 * _FadingNoiseScale ), 0, 0.0) ).r;
				float localMyCustomExpression16_g11895 = MyCustomExpression16_g11895( linValue16_g11895 );
				float clampResult3_g11894 = clamp( ( ( _FadingFade - ( distance( _FadingPosition , temp_output_27_0_g11894 ) + ( localMyCustomExpression16_g11895 * _FadingNoiseFactor ) ) ) / max( _FadingWidth , 0.001 ) ) , 0.0 , 1.0 );
				...
				float staticSwitch139 = ( _FadingFade * ( tex2DNode3_g11898.r * tex2DNode3_g11898.a ) );
				#elif defined( _SHADERFADING_DISSOLVE )
				float staticSwitch139 = clampResult14_g11896;
				#elif defined( _SHADERFADING_SPREAD )
				float staticSwitch139 = clampResult3_g11894;
				#else
				float staticSwitch139 = _FadingFade;
				#endif
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 staticSwitch1_g11900 = temp_output_61_0_g11900;
				#elif defined( _SHADERSPACE_OBJECT )
				float2 staticSwitch1_g11900 = (IN.ase_texcoord3.xyz).xy;
				#elif defined( _SHADERSPACE_OBJECT_SCALED )
				float2 staticSwitch1_g11900 = ( (IN.ase_texcoord3.xyz).xy * (ase_objectScale).xy );
				#elif defined( _SHADERSPACE_WORLD )
				float2 staticSwitch1_g11900 = (ase_positionWS).xy;
				#elif defined( _SHADERSPACE_UI_GRAPHIC )
				float2 staticSwitch1_g11900 = ( texCoord23_g11900 * ( appendResult28_g11900 / _PixelsPerUnit ) );
				...
				#endif
				float temp_output_81_0_g11901 = unity_OrthoParams.y;
				float temp_output_8_0_g11901 = ( ( ( shaderTime237 * ( _HologramDistortionSpeed * temp_output_81_0_g11901 * 0.2 ) ) + ase_positionWS.y ) / temp_output_81_0_g11901 );
				float2 temp_cast_4 = (temp_output_8_0_g11901).xx;
				float2 temp_cast_5 = (_HologramDistortionDensity).xx;
				float linValue16_g11903 = tex2D( _UberNoiseTexture, ( temp_cast_4 * temp_cast_5 ) ).r;
				float localMyCustomExpression16_g11903 = MyCustomExpression16_g11903( linValue16_g11903 );
				float clampResult75_g11901 = clamp( localMyCustomExpression16_g11903 , 0.075 , 0.6 );
				float2 temp_cast_6 = (temp_output_8_0_g11901).xx;
				float2 temp_cast_7 = (_HologramDistortionScale).xx;
				float linValue16_g11904 = tex2D( _UberNoiseTexture, ( temp_cast_6 * temp_cast_7 ) ).r;
				float localMyCustomExpression16_g11904 = MyCustomExpression16_g11904( linValue16_g11904 );
				float2 appendResult10_g11902 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 appendResult2_g11902 = (float2(1.0 , ( _MainTex_TexelSize.z / _MainTex_TexelSize.w )));
				#ifdef _RESIZABLETEXTURE_ON
				float2 staticSwitch9_g11902 = appendResult2_g11902;
				#else
				float2 staticSwitch9_g11902 = ( float2( 100,100 ) / appendResult10_g11902 );
				#endif
				float hologramFade182 = _HologramFade;
				float2 appendResult44_g11901 = (float2(( ( ( clampResult75_g11901 * ( localMyCustomExpression16_g11904 - 0.5 ) ) * _HologramDistortionOffset * staticSwitch9_g11902.x ) * hologramFade182 ) , 0.0));
				#ifdef _ENABLEHOLOGRAM_ON
				float2 staticSwitch59 = ( staticSwitch82 + appendResult44_g11901 );
				#else
				...
				float linValue16_g11906 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchDistortionSpeed * shaderTime237 ) ) * _GlitchDistortionScale ) ).r;
				...
				float2 staticSwitch62 = ( staticSwitch59 + ( ( localMyCustomExpression16_g11906 - 0.5 ) * _GlitchDistortion * glitchFade152 ) );
				#else
				float2 staticSwitch62 = staticSwitch59;
				#endif
				float2 temp_output_1_0_g11916 = staticSwitch62;
				float2 temp_output_26_0_g11916 = shaderPosition235;
				float temp_output_25_0_g11916 = shaderTime237;
				float linValue16_g11926 = tex2D( _UberNoiseTexture, ( ( temp_output_26_0_g11916 + ( _UVDistortSpeed * temp_output_25_0_g11916 ) ) * _UVDistortNoiseScale ) ).r;
				float localMyCustomExpression16_g11926 = MyCustomExpression16_g11926( linValue16_g11926 );
				float2 lerpResult21_g11923 = lerp( _UVDistortFrom , _UVDistortTo , localMyCustomExpression16_g11926);
				float2 appendResult10_g11925 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 appendResult2_g11925 = (float2(1.0 , ( _MainTex_TexelSize.z / _MainTex_TexelSize.w )));
				#ifdef _RESIZABLETEXTURE_ON
				float2 staticSwitch9_g11925 = appendResult2_g11925;
				#else
				float2 staticSwitch9_g11925 = ( float2( 100,100 ) / appendResult10_g11925 );
				#endif
				float2 uv_UVDistortMask = IN.texcoord.xy * _UVDistortMask_ST.xy + _UVDistortMask_ST.zw;
				float4 tex2DNode3_g11924 = tex2D( _UVDistortMask, uv_UVDistortMask );
				#ifdef _UVDISTORTMASKTOGGLE_ON
				float staticSwitch29_g11923 = ( _UVDistortFade * ( tex2DNode3_g11924.r * tex2DNode3_g11924.a ) );
				#else
				float staticSwitch29_g11923 = _UVDistortFade;
				#endif
				#ifdef _ENABLEUVDISTORT_ON
				float2 staticSwitch5_g11916 = ( temp_output_1_0_g11916 + ( lerpResult21_g11923 * staticSwitch9_g11925 * staticSwitch29_g11923 ) );
				#else
				float2 staticSwitch5_g11916 = temp_output_1_0_g11916;
				#endif
				float2 temp_output_1_0_g11922 = staticSwitch5_g11916;
				#ifdef _ENABLESQUEEZE_ON
				float2 staticSwitch7_g11916 = ( temp_output_1_0_g11922 + ( ( temp_output_1_0_g11922 - _SqueezeCenter ) * pow( distance( temp_output_1_0_g11922 , _SqueezeCenter ) , _SqueezePower ) * _SqueezeScale * _SqueezeFade ) );
				#else
				float2 staticSwitch7_g11916 = staticSwitch5_g11916;
				#endif
				float3 rotatedValue36_g11921 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( staticSwitch7_g11916 ,  0.0 ), float3( 0,0,1 ), ( sin( ( temp_output_25_0_g11916 * _SineRotateFrequency ) ) * ( ( _SineRotateAngle / 360.0 ) * UNITY_PI ) * _SineRotateFade ) );
				#ifdef _ENABLESINEROTATE_ON
				float2 staticSwitch9_g11916 = (rotatedValue36_g11921).xy;
				#else
				float2 staticSwitch9_g11916 = staticSwitch7_g11916;
				#endif
				float3 rotatedValue8_g11920 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( staticSwitch9_g11916 ,  0.0 ), float3( 0,0,1 ), ( temp_output_25_0_g11916 * _UVRotateSpeed * UNITY_PI ) );
				#ifdef _ENABLEUVROTATE_ON
				float2 staticSwitch16_g11916 = (rotatedValue8_g11920).xy;
				#else
				float2 staticSwitch16_g11916 = staticSwitch9_g11916;
				#endif
				#ifdef _ENABLEUVSCROLL_ON
				float2 staticSwitch14_g11916 = ( ( _UVScrollSpeed * temp_output_25_0_g11916 ) + staticSwitch16_g11916 );
				#else
				float2 staticSwitch14_g11916 = staticSwitch16_g11916;
				#endif
				float2 appendResult35_g11918 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 MultFactor30_g11918 = ( ( _PixelatePixelDensity * ( appendResult35_g11918 / _PixelatePixelsPerUnit ) ) * ( 1.0 / max( _PixelateFade , 1E-05 ) ) );
				float2 clampResult46_g11918 = clamp( ( floor( ( MultFactor30_g11918 * ( staticSwitch14_g11916 + ( float2( 0.5,0.5 ) / MultFactor30_g11918 ) ) ) ) / MultFactor30_g11918 ) , float2( 0,0 ) , float2( 1,1 ) );
				#ifdef _ENABLEPIXELATE_ON
				float2 staticSwitch4_g11916 = clampResult46_g11918;
				#else
				float2 staticSwitch4_g11916 = staticSwitch14_g11916;
				#endif
				#ifdef _ENABLEUVSCALE_ON
				float2 staticSwitch24_g11916 = ( ( ( staticSwitch4_g11916 - _UVScalePivot ) / _UVScaleScale ) + _UVScalePivot );
				#else
				float2 staticSwitch24_g11916 = staticSwitch4_g11916;
				#endif
				float2 temp_output_1_0_g11927 = staticSwitch24_g11916;
				float temp_output_7_0_g11927 = ( sin( ( _WiggleFrequency * ( temp_output_26_0_g11916.y + ( _WiggleSpeed * temp_output_25_0_g11916 ) ) ) ) * _WiggleOffset * _WiggleFade );
				#ifdef _WIGGLEFIXEDGROUNDTOGGLE_ON
				float staticSwitch18_g11927 = ( temp_output_7_0_g11927 * temp_output_1_0_g11927.y );
				#else
				float staticSwitch18_g11927 = temp_output_7_0_g11927;
				#endif
				float2 appendResult12_g11927 = (float2(staticSwitch18_g11927 , 0.0));
				#ifdef _ENABLEWIGGLE_ON
				float2 staticSwitch13_g11927 = ( temp_output_1_0_g11927 + appendResult12_g11927 );
				#else
				float2 staticSwitch13_g11927 = temp_output_1_0_g11927;
				#endif
				float2 temp_output_484_0 = staticSwitch13_g11927;
				float2 texCoord131 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_FadingMask = IN.texcoord.xy * _FadingMask_ST.xy + _FadingMask_ST.zw;
				float4 tex2DNode3_g11898 = tex2D( _FadingMask, uv_FadingMask );
				float temp_output_4_0_g11896 = max( _FadingWidth , 0.001 );
				float linValue16_g11897 = tex2D( _UberNoiseTexture, ( shaderPosition235 * _FadingNoiseScale ) ).r;
				float localMyCustomExpression16_g11897 = MyCustomExpression16_g11897( linValue16_g11897 );
				float clampResult14_g11896 = clamp( ( ( ( _FadingFade * ( 1.0 + temp_output_4_0_g11896 ) ) - localMyCustomExpression16_g11897 ) / temp_output_4_0_g11896 ) , 0.0 , 1.0 );
				float2 temp_output_27_0_g11894 = shaderPosition235;
				float linValue16_g11895 = tex2D( _UberNoiseTexture, ( temp_output_27_0_g11894 * _FadingNoiseScale ) ).r;
				float localMyCustomExpression16_g11895 = MyCustomExpression16_g11895( linValue16_g11895 );
				float clampResult3_g11894 = clamp( ( ( _FadingFade - ( distance( _FadingPosition , temp_output_27_0_g11894 ) + ( localMyCustomExpression16_g11895 * _FadingNoiseFactor ) ) ) / max( _FadingWidth , 0.001 ) ) , 0.0 , 1.0 );
				#if defined( _SHADERFADING_NONE )
				float staticSwitch139 = _FadingFade;
				...
				#endif
				float2 break14_g11928 = staticSwitch485;
				float2 break11_g11928 = float2( 0,0 );
				float2 break10_g11928 = float2( 1,1 );
				float2 break9_g11928 = spriteRectMin376;
				float2 break8_g11928 = spriteRectMax377;
				float2 appendResult15_g11928 = (float2( (break9_g11928.x + ( break14_g11928.x - break11_g11928.x ) * ( break8_g11928.x - break9_g11928.x ) / ( break10_g11928.x - break11_g11928.x ) ) ,  (break9_g11928.y + ( break14_g11928.y - break11_g11928.y ) * ( break8_g11928.y - break9_g11928.y ) / ( break10_g11928.y - break11_g11928.y ) )));
				#ifdef _SPRITESHEETFIX_ON
				float2 staticSwitch371 = min( max( appendResult15_g11928 , spriteRectMin376 ) , spriteRectMax377 );
				#else
				float2 staticSwitch371 = staticSwitch485;
				#endif
				float2 appendResult7_g12075 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				#ifdef _PIXELPERFECTUV_ON
				float2 staticSwitch427 = ( originalUV460 + ( floor( ( ( staticSwitch371 - uvAfterPixelArt450 ) * appendResult7_g12075 ) ) / appendResult7_g12075 ) );
				#else
				...
				float4 temp_output_1_0_g11907 = originalColor191;
				float4 temp_output_1_0_g11908 = temp_output_1_0_g11907;
				float2 temp_output_7_0_g11907 = finalUV146;
				float2 temp_output_43_0_g11908 = temp_output_7_0_g11907;
				float2 temp_cast_15 = (_SmokeNoiseScale).xx;
				float linValue16_g11909 = tex2D( _UberNoiseTexture, ( ( ( IN.color.r * (( _SmokeVertexSeed )?( 5.0 ):( 0.0 )) ) + temp_output_43_0_g11908 ) * temp_cast_15 ) ).r;
				float localMyCustomExpression16_g11909 = MyCustomExpression16_g11909( linValue16_g11909 );
				float clampResult28_g11908 = clamp( ( ( ( localMyCustomExpression16_g11909 - 1.0 ) * _SmokeNoiseFactor ) + ( ( ( IN.color.a / 2.5 ) - distance( temp_output_43_0_g11908 , float2( 0.5,0.5 ) ) ) * 2.5 * _SmokeSmoothness ) ) , 0.0 , 1.0 );
				float3 lerpResult34_g11908 = lerp( (temp_output_1_0_g11908).rgb , float3( 0,0,0 ) , ( ( 1.0 - clampResult28_g11908 ) * _SmokeDarkEdge ));
				float4 appendResult31_g11908 = (float4(lerpResult34_g11908 , ( clampResult28_g11908 * _SmokeAlpha * temp_output_1_0_g11908.a )));
				#ifdef _ENABLESMOKE_ON
				float4 staticSwitch2_g11907 = appendResult31_g11908;
				#else
				float4 staticSwitch2_g11907 = temp_output_1_0_g11907;
				#endif
				float4 temp_output_1_0_g11910 = staticSwitch2_g11907;
				float2 temp_output_57_0_g11910 = temp_output_7_0_g11907;
				float4 tex2DNode3_g11910 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g11910 );
				float linValue16_g11911 = tex2D( _UberNoiseTexture, ( temp_output_57_0_g11910 * _CustomFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11911 = MyCustomExpression16_g11911( linValue16_g11911 );
				float clampResult37_g11910 = clamp( ( ( ( IN.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g11910.r + ( localMyCustomExpression16_g11911 * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g11910 = (float4((temp_output_1_0_g11910).rgb , ( temp_output_1_0_g11910.a * pow( clampResult37_g11910 , ( _CustomFadeSmoothness / max( tex2DNode3_g11910.r , 0.05 ) ) ) * _CustomFadeAlpha )));
				#ifdef _ENABLECUSTOMFADE_ON
				float4 staticSwitch3_g11907 = appendResult13_g11910;
				#else
				float4 staticSwitch3_g11907 = staticSwitch2_g11907;
				#endif
				float4 temp_output_1_0_g11912 = staticSwitch3_g11907;
				float4 temp_output_1_0_g11913 = temp_output_1_0_g11912;
				float2 appendResult4_g11913 = (float2(ase_positionWS.x , ase_positionWS.y));
				float2 temp_output_44_0_g11913 = ( appendResult4_g11913 * _CheckerboardTiling * 0.5 );
				float2 break12_g11913 = step( ( ceil( temp_output_44_0_g11913 ) - temp_output_44_0_g11913 ) , float2( 0.5,0.5 ) );
				float4 appendResult42_g11913 = (float4(( (temp_output_1_0_g11913).rgb * min( ( _CheckerboardDarken + abs( ( -break12_g11913.x + break12_g11913.y ) ) ) , 1.0 ) ) , temp_output_1_0_g11913.a));
				#ifdef _ENABLECHECKERBOARD_ON
				float4 staticSwitch2_g11912 = appendResult42_g11913;
				#else
				float4 staticSwitch2_g11912 = temp_output_1_0_g11912;
				#endif
				float2 temp_output_75_0_g11914 = finalUV146;
				float linValue16_g11915 = tex2D( _UberNoiseTexture, ( ( ( shaderTime237 * _FlameSpeed ) + temp_output_75_0_g11914 ) * _FlameNoiseScale ) ).r;
				float localMyCustomExpression16_g11915 = MyCustomExpression16_g11915( linValue16_g11915 );
				float saferPower57_g11914 = abs( max( ( temp_output_75_0_g11914.y - 0.2 ) , 0.0 ) );
				float temp_output_47_0_g11914 = max( _FlameRadius , 0.01 );
				float clampResult70_g11914 = clamp( ( ( ( localMyCustomExpression16_g11915 * pow( saferPower57_g11914 , _FlameNoiseHeightFactor ) * _FlameNoiseFactor ) + ( ( temp_output_47_0_g11914 - distance( temp_output_75_0_g11914 , float2( 0.5,0.4 ) ) ) / temp_output_47_0_g11914 ) ) * _FlameSmooth ) , 0.0 , 1.0 );
				float temp_output_63_0_g11914 = ( clampResult70_g11914 * _FlameBrightness );
				float4 appendResult31_g11914 = (float4(temp_output_63_0_g11914 , temp_output_63_0_g11914 , temp_output_63_0_g11914 , clampResult70_g11914));
				#ifdef _ENABLEFLAME_ON
				float4 staticSwitch6_g11912 = ( appendResult31_g11914 * staticSwitch2_g11912 );
				#else
				float4 staticSwitch6_g11912 = staticSwitch2_g11912;
				#endif
				float4 temp_output_3_0_g12026 = staticSwitch6_g11912;
				...
				#endif
				float4 temp_output_3_0_g12076 = staticSwitch57;
				float4 temp_output_1_0_g12106 = temp_output_3_0_g12076;
				float2 temp_output_41_0_g12076 = shaderPosition235;
				float2 temp_output_99_0_g12106 = temp_output_41_0_g12076;
				float temp_output_40_0_g12076 = shaderTime237;
				float linValue16_g12111 = tex2D( _UberNoiseTexture, ( ( ( temp_output_40_0_g12076 * _CamouflageDistortionSpeed ) + temp_output_99_0_g12106 ) * _CamouflageDistortionScale ) ).r;
				float localMyCustomExpression16_g12111 = MyCustomExpression16_g12111( linValue16_g12111 );
				#ifdef _CAMOUFLAGEANIMATIONTOGGLE_ON
				float2 staticSwitch101_g12106 = ( ( ( localMyCustomExpression16_g12111 - 0.25 ) * _CamouflageDistortionIntensity ) + temp_output_99_0_g12106 );
				#else
				float2 staticSwitch101_g12106 = temp_output_99_0_g12106;
				#endif
				float linValue16_g12108 = tex2D( _UberNoiseTexture, ( staticSwitch101_g12106 * _CamouflageNoiseScaleA ) ).r;
				float localMyCustomExpression16_g12108 = MyCustomExpression16_g12108( linValue16_g12108 );
				float clampResult52_g12106 = clamp( ( ( _CamouflageDensityA - localMyCustomExpression16_g12108 ) / max( _CamouflageSmoothnessA , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult55_g12106 = lerp( _CamouflageBaseColor , ( _CamouflageColorA * clampResult52_g12106 ) , clampResult52_g12106);
				float linValue16_g12110 = tex2D( _UberNoiseTexture, ( ( staticSwitch101_g12106 + float2( 12.3,12.3 ) ) * _CamouflageNoiseScaleB ) ).r;
				float localMyCustomExpression16_g12110 = MyCustomExpression16_g12110( linValue16_g12110 );
				float clampResult65_g12106 = clamp( ( ( _CamouflageDensityB - localMyCustomExpression16_g12110 ) / max( _CamouflageSmoothnessB , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult68_g12106 = lerp( lerpResult55_g12106 , ( _CamouflageColorB * clampResult65_g12106 ) , clampResult65_g12106);
				float4 break2_g12109 = temp_output_1_0_g12106;
				float3 lerpResult4_g12106 = lerp( (temp_output_1_0_g12106).rgb , ( (lerpResult68_g12106).rgb * pow( max( ( ( break2_g12109.x + break2_g12109.x + break2_g12109.y + break2_g12109.y + break2_g12109.y + break2_g12109.z ) / 6.0 ) , 0.0001 ) , max( _CamouflageContrast , 0.0001 ) ) ) , _CamouflageFade);
				float4 appendResult7_g12106 = (float4(lerpResult4_g12106 , temp_output_1_0_g12106.a));
				#ifdef _ENABLECAMOUFLAGE_ON
				float4 staticSwitch26_g12076 = appendResult7_g12106;
				#else
				float4 staticSwitch26_g12076 = temp_output_3_0_g12076;
				#endif
				float4 temp_output_1_0_g12099 = staticSwitch26_g12076;
				float temp_output_59_0_g12099 = temp_output_40_0_g12076;
				float2 temp_output_58_0_g12099 = temp_output_41_0_g12076;
				float linValue16_g12100 = tex2D( _UberNoiseTexture, ( ( ( temp_output_59_0_g12099 * _MetalNoiseDistortionSpeed ) + temp_output_58_0_g12099 ) * _MetalNoiseDistortionScale ) ).r;
				float localMyCustomExpression16_g12100 = MyCustomExpression16_g12100( linValue16_g12100 );
				float linValue16_g12102 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g12100 - 0.25 ) * _MetalNoiseDistortion ) + ( ( temp_output_59_0_g12099 * _MetalNoiseSpeed ) + temp_output_58_0_g12099 ) ) * _MetalNoiseScale ) ).r;
				float localMyCustomExpression16_g12102 = MyCustomExpression16_g12102( linValue16_g12102 );
				float4 break2_g12101 = temp_output_1_0_g12099;
				float temp_output_5_0_g12099 = ( ( break2_g12101.x + break2_g12101.x + break2_g12101.y + break2_g12101.y + break2_g12101.y + break2_g12101.z ) / 6.0 );
				float2 uv_MetalMask = IN.texcoord.xy * _MetalMask_ST.xy + _MetalMask_ST.zw;
				float4 tex2DNode3_g12104 = tex2D( _MetalMask, uv_MetalMask );
				#ifdef _METALMASKTOGGLE_ON
				float staticSwitch60_g12099 = ( _MetalFade * ( tex2DNode3_g12104.r * tex2DNode3_g12104.a ) );
				#else
				float staticSwitch60_g12099 = _MetalFade;
				#endif
				float4 lerpResult45_g12099 = lerp( temp_output_1_0_g12099 , ( ( max( ( ( _MetalHighlightDensity - localMyCustomExpression16_g12102 ) / max( _MetalHighlightDensity , 0.01 ) ) , 0.0 ) * _MetalHighlightColor * pow( max( temp_output_5_0_g12099 , 0.0001 ) , max( _MetalHighlightContrast , 0.0001 ) ) ) + ( pow( max( temp_output_5_0_g12099 , 0.0001 ) , max( _MetalContrast , 0.0001 ) ) * _MetalColor ) ) , staticSwitch60_g12099);
				float4 appendResult8_g12099 = (float4((lerpResult45_g12099).rgb , (temp_output_1_0_g12099).a));
				#ifdef _ENABLEMETAL_ON
				float4 staticSwitch28_g12076 = appendResult8_g12099;
				#else
				float4 staticSwitch28_g12076 = staticSwitch26_g12076;
				#endif
				float4 temp_output_1_0_g12091 = staticSwitch28_g12076;
				float4 break2_g12092 = temp_output_1_0_g12091;
				float temp_output_7_0_g12091 = ( ( break2_g12092.x + break2_g12092.x + break2_g12092.y + break2_g12092.y + break2_g12092.y + break2_g12092.z ) / 6.0 );
				float2 temp_output_72_0_g12091 = temp_output_41_0_g12076;
				float linValue16_g12093 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g12091 * _FrozenSnowScale ) ).r;
				float localMyCustomExpression16_g12093 = MyCustomExpression16_g12093( linValue16_g12093 );
				float temp_output_73_0_g12091 = temp_output_40_0_g12076;
				float linValue16_g12095 = tex2D( _UberNoiseTexture, ( ( ( temp_output_73_0_g12091 * _FrozenHighlightDistortionSpeed ) + temp_output_72_0_g12091 ) * _FrozenHighlightDistortionScale ) ).r;
				float localMyCustomExpression16_g12095 = MyCustomExpression16_g12095( linValue16_g12095 );
				float linValue16_g12096 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g12095 - 0.25 ) * _FrozenHighlightDistortion ) + ( ( temp_output_73_0_g12091 * _FrozenHighlightSpeed ) + temp_output_72_0_g12091 ) ) * _FrozenHighlightScale ) ).r;
				float localMyCustomExpression16_g12096 = MyCustomExpression16_g12096( linValue16_g12096 );
				float3 lerpResult57_g12091 = lerp( (temp_output_1_0_g12091).rgb , ( ( pow( max( temp_output_7_0_g12091 , 0.0001 ) , max( _FrozenContrast , 0.0001 ) ) * (_FrozenTint).rgb ) + ( pow( max( temp_output_7_0_g12091 , 0.0001 ) , max( _FrozenSnowContrast , 0.0001 ) ) * ( (_FrozenSnowColor).rgb * max( ( _FrozenSnowDensity - localMyCustomExpression16_g12093 ) , 0.0 ) ) ) + (( max( ( ( _FrozenHighlightDensity - localMyCustomExpression16_g12096 ) / max( _FrozenHighlightDensity , 0.01 ) ) , 0.0 ) * _FrozenHighlightColor * pow( max( temp_output_7_0_g12091 , 0.0001 ) , max( _FrozenHighlightContrast , 0.0001 ) ) )).rgb ) , _FrozenFade);
				float4 appendResult26_g12091 = (float4(lerpResult57_g12091 , temp_output_1_0_g12091.a));
				#ifdef _ENABLEFROZEN_ON
				float4 staticSwitch29_g12076 = appendResult26_g12091;
				#else
				float4 staticSwitch29_g12076 = staticSwitch28_g12076;
				#endif
				float4 temp_output_1_0_g12085 = staticSwitch29_g12076;
				float3 temp_output_28_0_g12085 = (temp_output_1_0_g12085).rgb;
				float4 break2_g12089 = float4( temp_output_28_0_g12085 , 0.0 );
				float2 temp_output_72_0_g12085 = temp_output_41_0_g12076;
				float linValue16_g12088 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g12085 * _BurnSwirlNoiseScale ) ).r;
				float localMyCustomExpression16_g12088 = MyCustomExpression16_g12088( linValue16_g12088 );
				float linValue16_g12086 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g12088 - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_72_0_g12085 ) * _BurnInsideNoiseScale ) ).r;
				float localMyCustomExpression16_g12086 = MyCustomExpression16_g12086( linValue16_g12086 );
				float clampResult68_g12085 = clamp( ( _BurnInsideNoiseFactor - localMyCustomExpression16_g12086 ) , 0.0 , 1.0 );
				float linValue16_g12087 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g12085 * _BurnEdgeNoiseScale ) ).r;
				float localMyCustomExpression16_g12087 = MyCustomExpression16_g12087( linValue16_g12087 );
				float temp_output_15_0_g12085 = ( ( ( _BurnRadius - distance( temp_output_72_0_g12085 , _BurnPosition ) ) + ( localMyCustomExpression16_g12087 * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
				float clampResult18_g12085 = clamp( temp_output_15_0_g12085 , 0.0 , 1.0 );
				float3 lerpResult29_g12085 = lerp( temp_output_28_0_g12085 , ( pow( max( ( ( break2_g12089.x + break2_g12089.x + break2_g12089.y + break2_g12089.y + break2_g12089.y + break2_g12089.z ) / 6.0 ) , 0.0001 ) , max( _BurnInsideContrast , 0.0001 ) ) * ( ( (_BurnInsideNoiseColor).rgb * clampResult68_g12085 ) + (_BurnInsideColor).rgb ) ) , clampResult18_g12085);
				float3 lerpResult40_g12085 = lerp( temp_output_28_0_g12085 , ( lerpResult29_g12085 + ( ( step( temp_output_15_0_g12085 , 1.0 ) * step( 0.0 , temp_output_15_0_g12085 ) ) * (_BurnEdgeColor).rgb ) ) , _BurnFade);
				float4 appendResult43_g12085 = (float4(lerpResult40_g12085 , temp_output_1_0_g12085.a));
				#ifdef _ENABLEBURN_ON
				float4 staticSwitch32_g12076 = appendResult43_g12085;
				#else
				float4 staticSwitch32_g12076 = staticSwitch29_g12076;
				#endif
				float2 temp_output_42_0_g12081 = temp_output_41_0_g12076;
				float linValue16_g12082 = tex2D( _UberNoiseTexture, ( temp_output_42_0_g12081 * _RainbowNoiseScale ) ).r;
				float localMyCustomExpression16_g12082 = MyCustomExpression16_g12082( linValue16_g12082 );
				float3 hsvTorgb3_g12084 = HSVToRGB( float3(( ( ( distance( temp_output_42_0_g12081 , _RainbowCenter ) + ( localMyCustomExpression16_g12082 * _RainbowNoiseFactor ) ) * _RainbowDensity ) + ( _RainbowSpeed * temp_output_40_0_g12076 ) ),1.0,1.0) );
				float3 hsvTorgb36_g12081 = RGBToHSV( hsvTorgb3_g12084 );
				float3 hsvTorgb37_g12081 = HSVToRGB( float3(hsvTorgb36_g12081.x,_RainbowSaturation,( hsvTorgb36_g12081.z * _RainbowBrightness )) );
				float4 temp_output_1_0_g12081 = staticSwitch32_g12076;
				float4 break2_g12083 = temp_output_1_0_g12081;
				float saferPower24_g12081 = abs( ( ( break2_g12083.x + break2_g12083.x + break2_g12083.y + break2_g12083.y + break2_g12083.y + break2_g12083.z ) / 6.0 ) );
				float4 appendResult29_g12081 = (float4(( ( hsvTorgb37_g12081 * pow( saferPower24_g12081 , max( _RainbowContrast , 0.001 ) ) * _RainbowFade ) + (temp_output_1_0_g12081).rgb ) , temp_output_1_0_g12081.a));
				#ifdef _ENABLERAINBOW_ON
				float4 staticSwitch34_g12076 = appendResult29_g12081;
				#else
				float4 staticSwitch34_g12076 = staticSwitch32_g12076;
				#endif
				float4 temp_output_1_0_g12077 = staticSwitch34_g12076;
				float3 temp_output_57_0_g12077 = (temp_output_1_0_g12077).rgb;
				float4 break2_g12079 = temp_output_1_0_g12077;
				float3 temp_cast_69 = (( ( break2_g12079.x + break2_g12079.x + break2_g12079.y + break2_g12079.y + break2_g12079.y + break2_g12079.z ) / 6.0 )).xxx;
				float3 lerpResult92_g12077 = lerp( temp_cast_69 , temp_output_57_0_g12077 , _ShineSaturation);
				float3 temp_cast_70 = (max( max( _ShineContrast , 0.001 ) , 0.0001 )).xxx;
				float3 rotatedValue69_g12077 = RotateAroundAxis( float3( 0,0,0 ), float3( ( _ShineFrequency * temp_output_41_0_g12076 ) ,  0.0 ), float3( 0,0,1 ), ( ( _ShineRotation / 180.0 ) * UNITY_PI ) );
				float temp_output_103_0_g12077 = ( _ShineFrequency * _ShineWidth );
				float clampResult80_g12077 = clamp( ( ( ( sin( ( rotatedValue69_g12077.x - ( temp_output_40_0_g12076 * _ShineSpeed * _ShineFrequency ) ) ) - ( 1.0 - temp_output_103_0_g12077 ) ) / temp_output_103_0_g12077 ) * _ShineSmooth ) , 0.0 , 1.0 );
				float2 uv_ShineMask = IN.texcoord.xy * _ShineMask_ST.xy + _ShineMask_ST.zw;
				float4 tex2DNode3_g12078 = tex2D( _ShineMask, uv_ShineMask );
				#ifdef _SHINEMASKTOGGLE_ON
				float staticSwitch98_g12077 = ( _ShineFade * ( tex2DNode3_g12078.r * tex2DNode3_g12078.a ) );
				#else
				float staticSwitch98_g12077 = _ShineFade;
				#endif
				float4 appendResult8_g12077 = (float4(( temp_output_57_0_g12077 + ( ( pow( max( lerpResult92_g12077 , float3( 0.0001,0.0001,0.0001 ) ) , temp_cast_70 ) * (_ShineColor).rgb ) * clampResult80_g12077 * staticSwitch98_g12077 ) ) , (temp_output_1_0_g12077).a));
				#ifdef _ENABLESHINE_ON
				float4 staticSwitch36_g12076 = appendResult8_g12077;
				#else
				float4 staticSwitch36_g12076 = staticSwitch34_g12076;
				#endif
				float temp_output_41_0_g12112 = temp_output_40_0_g12076;
				float linValue16_g12114 = tex2D( _UberNoiseTexture, ( ( ( temp_output_41_0_g12112 * _PoisonNoiseSpeed ) + temp_output_41_0_g12076 ) * _PoisonNoiseScale ) ).r;
				float localMyCustomExpression16_g12114 = MyCustomExpression16_g12114( linValue16_g12114 );
				float3 temp_output_24_0_g12112 = (_PoisonColor).rgb;
				float4 temp_output_1_0_g12112 = staticSwitch36_g12076;
				float3 temp_output_28_0_g12112 = (temp_output_1_0_g12112).rgb;
				float4 break2_g12113 = float4( temp_output_28_0_g12112 , 0.0 );
				float3 lerpResult32_g12112 = lerp( temp_output_28_0_g12112 , ( temp_output_24_0_g12112 * ( ( break2_g12113.x + break2_g12113.x + break2_g12113.y + break2_g12113.y + break2_g12113.y + break2_g12113.z ) / 6.0 ) ) , ( _PoisonFade * _PoisonRecolorFactor ));
				float4 appendResult27_g12112 = (float4(( ( max( pow( max( abs( ( ( ( localMyCustomExpression16_g12114 + ( temp_output_41_0_g12112 * _PoisonShiftSpeed ) ) % 1.0 ) + -0.5 ) ) , 0.0001 ) , max( _PoisonDensity , 0.0001 ) ) , 0.0 ) * temp_output_24_0_g12112 * _PoisonFade * _PoisonNoiseBrightness ) + lerpResult32_g12112 ) , temp_output_1_0_g12112.a));
				#ifdef _ENABLEPOISON_ON
				float4 staticSwitch39_g12076 = appendResult27_g12112;
				#else
				float4 staticSwitch39_g12076 = staticSwitch36_g12076;
				#endif
				float4 temp_output_10_0_g12116 = staticSwitch39_g12076;
				float3 temp_output_12_0_g12116 = (temp_output_10_0_g12116).rgb;
				float2 temp_output_2_0_g12116 = temp_output_41_0_g12076;
				float temp_output_1_0_g12116 = temp_output_40_0_g12076;
				float2 temp_output_6_0_g12116 = ( temp_output_1_0_g12116 * _EnchantedSpeed );
				float linValue16_g12119 = tex2D( _UberNoiseTexture, ( ( ( temp_output_2_0_g12116 - ( ( temp_output_6_0_g12116 + float2( 1.234,5.6789 ) ) * float2( 0.95,1.05 ) ) ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g12119 = MyCustomExpression16_g12119( linValue16_g12119 );
				float linValue16_g12117 = tex2D( _UberNoiseTexture, ( ( ( temp_output_6_0_g12116 + temp_output_2_0_g12116 ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g12117 = MyCustomExpression16_g12117( linValue16_g12117 );
				float temp_output_36_0_g12116 = ( localMyCustomExpression16_g12119 + localMyCustomExpression16_g12117 );
				float temp_output_43_0_g12116 = ( temp_output_36_0_g12116 * 0.5 );
				float3 lerpResult42_g12116 = lerp( (_EnchantedLowColor).rgb , (_EnchantedHighColor).rgb , temp_output_43_0_g12116);
				float3 hsvTorgb53_g12116 = HSVToRGB( float3(( ( temp_output_43_0_g12116 * _EnchantedRainbowDensity ) + ( _EnchantedRainbowSpeed * temp_output_1_0_g12116 ) ),_EnchantedRainbowSaturation,1.0) );
				#ifdef _ENCHANTEDRAINBOWTOGGLE_ON
				float3 staticSwitch50_g12116 = hsvTorgb53_g12116;
				#else
				float3 staticSwitch50_g12116 = lerpResult42_g12116;
				#endif
				float4 break2_g12118 = temp_output_10_0_g12116;
				float3 temp_output_40_0_g12116 = ( staticSwitch50_g12116 * pow( max( ( ( break2_g12118.x + break2_g12118.x + break2_g12118.y + break2_g12118.y + break2_g12118.y + break2_g12118.z ) / 6.0 ) , 0.0001 ) , max( _EnchantedContrast , 0.0001 ) ) * _EnchantedBrightness );
				float temp_output_45_0_g12116 = ( max( ( temp_output_36_0_g12116 - _EnchantedReduce ) , 0.0 ) * _EnchantedFade );
				float3 lerpResult44_g12116 = lerp( temp_output_12_0_g12116 , temp_output_40_0_g12116 , temp_output_45_0_g12116);
				#ifdef _ENCHANTEDLERPTOGGLE_ON
				float3 staticSwitch47_g12116 = lerpResult44_g12116;
				#else
				float3 staticSwitch47_g12116 = ( temp_output_12_0_g12116 + ( temp_output_40_0_g12116 * temp_output_45_0_g12116 ) );
				#endif
				float4 appendResult19_g12116 = (float4(staticSwitch47_g12116 , temp_output_10_0_g12116.a));
				#ifdef _ENABLEENCHANTED_ON
				float4 staticSwitch11_g12116 = appendResult19_g12116;
				#else
				float4 staticSwitch11_g12116 = temp_output_10_0_g12116;
				#endif
				float4 temp_output_1_0_g12121 = staticSwitch11_g12116;
				float4 break5_g12121 = temp_output_1_0_g12121;
				float3 appendResult32_g12121 = (float3(break5_g12121.r , break5_g12121.g , break5_g12121.b));
				float4 break2_g12122 = temp_output_1_0_g12121;
				float temp_output_4_0_g12121 = ( ( break2_g12122.x + break2_g12122.x + break2_g12122.y + break2_g12122.y + break2_g12122.y + break2_g12122.z ) / 6.0 );
				float temp_output_11_0_g12121 = ( ( ( temp_output_4_0_g12121 + ( temp_output_40_0_g12076 * _ShiftingSpeed ) ) * _ShiftingDensity ) % 1.0 );
				float3 lerpResult20_g12121 = lerp( (_ShiftingColorA).rgb , (_ShiftingColorB).rgb , ( abs( ( temp_output_11_0_g12121 - 0.5 ) ) * 2.0 ));
				float3 hsvTorgb12_g12121 = HSVToRGB( float3(temp_output_11_0_g12121,_ShiftingSaturation,_ShiftingBrightness) );
				#ifdef _SHIFTINGRAINBOWTOGGLE_ON
				float3 staticSwitch26_g12121 = hsvTorgb12_g12121;
				#else
				float3 staticSwitch26_g12121 = ( lerpResult20_g12121 * _ShiftingBrightness );
				#endif
				float3 lerpResult31_g12121 = lerp( appendResult32_g12121 , ( staticSwitch26_g12121 * pow( max( temp_output_4_0_g12121 , 0.0001 ) , max( _ShiftingContrast , 0.0001 ) ) ) , _ShiftingFade);
				float4 appendResult6_g12121 = (float4(lerpResult31_g12121 , break5_g12121.a));
				#ifdef _ENABLESHIFTING_ON
				float4 staticSwitch33_g12121 = appendResult6_g12121;
				#else
				float4 staticSwitch33_g12121 = temp_output_1_0_g12121;
				#endif
				float4 temp_output_5_0_g12128 = staticSwitch33_g12121;
				float4 break6_g12128 = temp_output_5_0_g12128;
				float3 appendResult11_g12128 = (float3(break6_g12128.r , break6_g12128.g , break6_g12128.b));
				float temp_output_27_0_g12128 = temp_output_40_0_g12076;
				#ifdef _TEXTURELAYER1SCROLLTOGGLE_ON
				float2 staticSwitch73_g12128 = ( _TextureLayer1Offset + ( _TextureLayer1ScrollSpeed * temp_output_27_0_g12128 ) );
				#else
				float2 staticSwitch73_g12128 = _TextureLayer1Offset;
				#endif
				float2 temp_output_72_0_g12128 = ( ( _TextureLayer1Scale * temp_output_41_0_g12076 ) - staticSwitch73_g12128 );
				float2 temp_cast_79 = (_TextureLayer1EdgeClip).xx;
				float2 UV10_g12129 = ( ( ( ( ( ( ( ( ( temp_output_72_0_g12128 % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) ) - float2( 0.5,0.5 ) ) * ( float2( 1,1 ) - temp_cast_79 ) ) + float2( 0.5,0.5 ) ) % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) );
				int Width10_g12129 = _TextureLayer1Columns;
				int Height10_g12129 = _TextureLayer1Rows;
				float Tile10_g12129 = round( ( ( _TextureLayer1Speed * temp_output_27_0_g12128 ) + _TextureLayer1StartFrame ) );
				float2 Invert10_g12129 = float2( 0,1 );
				float2 localMyCustomExpression10_g12129 = MyCustomExpression10_g12129( UV10_g12129 , Width10_g12129 , Height10_g12129 , Tile10_g12129 , Invert10_g12129 );
				#ifdef _TEXTURELAYER1SHEETTOGGLE_ON
				float2 staticSwitch20_g12128 = localMyCustomExpression10_g12129;
				#else
				float2 staticSwitch20_g12128 = temp_output_72_0_g12128;
				#endif
				float4 tex2DNode3_g12128 = tex2D( _TextureLayer1Texture, staticSwitch20_g12128 );
				float3 appendResult13_g12128 = (float3(tex2DNode3_g12128.r , tex2DNode3_g12128.g , tex2DNode3_g12128.b));
				float3 appendResult18_g12128 = (float3(_TextureLayer1Color.r , _TextureLayer1Color.g , _TextureLayer1Color.b));
				float3 temp_output_16_0_g12128 = ( appendResult13_g12128 * appendResult18_g12128 );
				float4 break2_g12130 = temp_output_5_0_g12128;
				#ifdef _TEXTURELAYER1CONTRASTTOGGLE_ON
				float3 staticSwitch80_g12128 = ( pow( max( ( ( break2_g12130.x + break2_g12130.x + break2_g12130.y + break2_g12130.y + break2_g12130.y + break2_g12130.z ) / 6.0 ) , 0.0001 ) , max( _TextureLayer1Contrast , 0.0001 ) ) * temp_output_16_0_g12128 );
				#else
				float3 staticSwitch80_g12128 = temp_output_16_0_g12128;
				#endif
				float3 lerpResult12_g12128 = lerp( appendResult11_g12128 , staticSwitch80_g12128 , ( tex2DNode3_g12128.a * _TextureLayer1Fade ));
				float4 appendResult14_g12128 = (float4(lerpResult12_g12128 , break6_g12128.a));
				#ifdef _ENABLETEXTURELAYER1_ON
				float4 staticSwitch15_g12128 = appendResult14_g12128;
				#else
				float4 staticSwitch15_g12128 = temp_output_5_0_g12128;
				#endif
				float4 temp_output_5_0_g12124 = staticSwitch15_g12128;
				float4 break6_g12124 = temp_output_5_0_g12124;
				float3 appendResult11_g12124 = (float3(break6_g12124.r , break6_g12124.g , break6_g12124.b));
				float temp_output_27_0_g12124 = temp_output_40_0_g12076;
				#ifdef _TEXTURELAYER2SCROLLTOGGLE_ON
				float2 staticSwitch73_g12124 = ( _TextureLayer2Offset + ( _TextureLayer2ScrollSpeed * temp_output_27_0_g12124 ) );
				#else
				float2 staticSwitch73_g12124 = _TextureLayer2Offset;
				#endif
				float2 temp_output_72_0_g12124 = ( ( _TextureLayer2Scale * temp_output_41_0_g12076 ) - staticSwitch73_g12124 );
				float2 temp_cast_82 = (_TextureLayer2EdgeClip).xx;
				float2 UV10_g12125 = ( ( ( ( ( ( ( ( ( temp_output_72_0_g12124 % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) ) - float2( 0.5,0.5 ) ) * ( float2( 1,1 ) - temp_cast_82 ) ) + float2( 0.5,0.5 ) ) % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) );
				int Width10_g12125 = _TextureLayer2Columns;
				int Height10_g12125 = _TextureLayer2Rows;
				float Tile10_g12125 = round( ( ( _TextureLayer2Speed * temp_output_27_0_g12124 ) + _TextureLayer2StartFrame ) );
				float2 Invert10_g12125 = float2( 0,1 );
				float2 localMyCustomExpression10_g12125 = MyCustomExpression10_g12125( UV10_g12125 , Width10_g12125 , Height10_g12125 , Tile10_g12125 , Invert10_g12125 );
				#ifdef _TEXTURELAYER2SHEETTOGGLE_ON
				float2 staticSwitch20_g12124 = localMyCustomExpression10_g12125;
				#else
				float2 staticSwitch20_g12124 = temp_output_72_0_g12124;
				#endif
				float4 tex2DNode3_g12124 = tex2D( _TextureLayer2Texture, staticSwitch20_g12124 );
				float3 appendResult13_g12124 = (float3(tex2DNode3_g12124.r , tex2DNode3_g12124.g , tex2DNode3_g12124.b));
				float3 appendResult18_g12124 = (float3(_TextureLayer2Color.r , _TextureLayer2Color.g , _TextureLayer2Color.b));
				float3 temp_output_16_0_g12124 = ( appendResult13_g12124 * appendResult18_g12124 );
				float4 break2_g12126 = temp_output_5_0_g12124;
				#ifdef _TEXTURELAYER2CONTRASTTOGGLE_ON
				float3 staticSwitch84_g12124 = ( pow( max( ( ( break2_g12126.x + break2_g12126.x + break2_g12126.y + break2_g12126.y + break2_g12126.y + break2_g12126.z ) / 6.0 ) , 0.0001 ) , max( _TextureLayer2Contrast , 0.0001 ) ) * temp_output_16_0_g12124 );
				#else
				float3 staticSwitch84_g12124 = temp_output_16_0_g12124;
				#endif
				float3 lerpResult12_g12124 = lerp( appendResult11_g12124 , staticSwitch84_g12124 , ( tex2DNode3_g12124.a * _TextureLayer2Fade ));
				float4 appendResult14_g12124 = (float4(lerpResult12_g12124 , break6_g12124.a));
				#ifdef _ENABLETEXTURELAYER2_ON
				float4 staticSwitch15_g12124 = appendResult14_g12124;
				#else
				float4 staticSwitch15_g12124 = temp_output_5_0_g12124;
				#endif
				float4 temp_output_473_0 = staticSwitch15_g12124;
				float4 break4_g12132 = temp_output_473_0;
				float fullDistortionAlpha164 = _FullDistortionFade;
				float4 appendResult5_g12132 = (float4(break4_g12132.r , break4_g12132.g , break4_g12132.b , ( break4_g12132.a * fullDistortionAlpha164 )));
				#ifdef _ENABLEFULLDISTORTION_ON
				float4 staticSwitch77 = appendResult5_g12132;
				#else
				float4 staticSwitch77 = temp_output_473_0;
				#endif
				float4 break4_g12133 = staticSwitch77;
				float directionalDistortionAlpha167 = (( _DirectionalDistortionInvert )?( ( 1.0 - clampResult154_g11668 ) ):( clampResult154_g11668 ));
				float4 appendResult5_g12133 = (float4(break4_g12133.r , break4_g12133.g , break4_g12133.b , ( break4_g12133.a * directionalDistortionAlpha167 )));
				#ifdef _ENABLEDIRECTIONALDISTORTION_ON
				float4 staticSwitch75 = appendResult5_g12133;
				#else
				float4 staticSwitch75 = staticSwitch77;
				#endif
				float4 temp_output_1_0_g12134 = staticSwitch75;
				float4 temp_output_1_0_g12135 = temp_output_1_0_g12134;
				float temp_output_53_0_g12135 = max( _FullAlphaDissolveWidth , 0.001 );
				float2 temp_output_18_0_g12134 = shaderPosition235;
				float linValue16_g12136 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g12134 * _FullAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g12136 = MyCustomExpression16_g12136( linValue16_g12136 );
				float clampResult17_g12135 = clamp( ( ( ( _FullAlphaDissolveFade * ( 1.0 + temp_output_53_0_g12135 ) ) - localMyCustomExpression16_g12136 ) / temp_output_53_0_g12135 ) , 0.0 , 1.0 );
				float4 appendResult3_g12135 = (float4((temp_output_1_0_g12135).rgb , ( temp_output_1_0_g12135.a * clampResult17_g12135 )));
				#ifdef _ENABLEFULLALPHADISSOLVE_ON
				float4 staticSwitch3_g12134 = appendResult3_g12135;
				#else
				float4 staticSwitch3_g12134 = temp_output_1_0_g12134;
				#endif
				float linValue16_g12144 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g12134 * _FullGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g12144 = MyCustomExpression16_g12144( linValue16_g12144 );
				float temp_output_5_0_g12143 = localMyCustomExpression16_g12144;
				float temp_output_61_0_g12143 = step( temp_output_5_0_g12143 , _FullGlowDissolveFade );
				float temp_output_53_0_g12143 = max( ( _FullGlowDissolveFade * _FullGlowDissolveWidth ) , 0.001 );
				float4 temp_output_1_0_g12143 = staticSwitch3_g12134;
				float4 appendResult3_g12143 = (float4(( ( (_FullGlowDissolveEdgeColor).rgb * ( temp_output_61_0_g12143 - step( temp_output_5_0_g12143 , ( ( _FullGlowDissolveFade * ( 1.01 + temp_output_53_0_g12143 ) ) - temp_output_53_0_g12143 ) ) ) ) + (temp_output_1_0_g12143).rgb ) , ( temp_output_1_0_g12143.a * temp_output_61_0_g12143 )));
				#ifdef _ENABLEFULLGLOWDISSOLVE_ON
				float4 staticSwitch5_g12134 = appendResult3_g12143;
				#else
				float4 staticSwitch5_g12134 = staticSwitch3_g12134;
				#endif
				float4 temp_output_1_0_g12145 = staticSwitch5_g12134;
				float2 temp_output_76_0_g12145 = temp_output_18_0_g12134;
				float linValue16_g12146 = tex2D( _UberNoiseTexture, ( temp_output_76_0_g12145 * _SourceAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g12146 = MyCustomExpression16_g12146( linValue16_g12146 );
				float clampResult17_g12145 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_76_0_g12145 ) + ( localMyCustomExpression16_g12146 * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g12145 = (float4((temp_output_1_0_g12145).rgb , ( temp_output_1_0_g12145.a * (( _SourceAlphaDissolveInvert )?( ( 1.0 - clampResult17_g12145 ) ):( clampResult17_g12145 )) )));
				#ifdef _ENABLESOURCEALPHADISSOLVE_ON
				float4 staticSwitch8_g12134 = appendResult3_g12145;
				#else
				float4 staticSwitch8_g12134 = staticSwitch5_g12134;
				#endif
				float2 temp_output_90_0_g12141 = temp_output_18_0_g12134;
				float linValue16_g12142 = tex2D( _UberNoiseTexture, ( temp_output_90_0_g12141 * _SourceGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g12142 = MyCustomExpression16_g12142( linValue16_g12142 );
				float temp_output_65_0_g12141 = ( distance( _SourceGlowDissolvePosition , temp_output_90_0_g12141 ) + ( localMyCustomExpression16_g12142 * _SourceGlowDissolveNoiseFactor ) );
				float temp_output_75_0_g12141 = step( temp_output_65_0_g12141 , _SourceGlowDissolveFade );
				float temp_output_76_0_g12141 = step( temp_output_65_0_g12141 , ( _SourceGlowDissolveFade - max( _SourceGlowDissolveWidth , 0.001 ) ) );
				float4 temp_output_1_0_g12141 = staticSwitch8_g12134;
				float4 appendResult3_g12141 = (float4(( ( max( ( temp_output_75_0_g12141 - temp_output_76_0_g12141 ) , 0.0 ) * (_SourceGlowDissolveEdgeColor).rgb ) + (temp_output_1_0_g12141).rgb ) , ( temp_output_1_0_g12141.a * (( _SourceGlowDissolveInvert )?( ( 1.0 - temp_output_76_0_g12141 ) ):( temp_output_75_0_g12141 )) )));
				#ifdef _ENABLESOURCEGLOWDISSOLVE_ON
				float4 staticSwitch9_g12134 = appendResult3_g12141;
				#else
				float4 staticSwitch9_g12134 = staticSwitch8_g12134;
				#endif
				float4 temp_output_1_0_g12137 = staticSwitch9_g12134;
				float2 temp_output_161_0_g12137 = temp_output_18_0_g12134;
				float3 rotatedValue136_g12137 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_161_0_g12137 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g12137 = rotatedValue136_g12137;
				float linValue16_g12138 = tex2D( _UberNoiseTexture, ( temp_output_161_0_g12137 * _DirectionalAlphaFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g12138 = MyCustomExpression16_g12138( linValue16_g12138 );
				float clampResult154_g12137 = clamp( ( ( break130_g12137.x + break130_g12137.y + _DirectionalAlphaFadeFade + ( localMyCustomExpression16_g12138 * _DirectionalAlphaFadeNoiseFactor ) ) / max( _DirectionalAlphaFadeWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g12137 = (float4((temp_output_1_0_g12137).rgb , ( temp_output_1_0_g12137.a * (( _DirectionalAlphaFadeInvert )?( ( 1.0 - clampResult154_g12137 ) ):( clampResult154_g12137 )) )));
				#ifdef _ENABLEDIRECTIONALALPHAFADE_ON
				float4 staticSwitch11_g12134 = appendResult3_g12137;
				#else
				float4 staticSwitch11_g12134 = staticSwitch9_g12134;
				#endif
				float2 temp_output_171_0_g12139 = temp_output_18_0_g12134;
				float3 rotatedValue136_g12139 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_171_0_g12139 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalGlowFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g12139 = rotatedValue136_g12139;
				float linValue16_g12140 = tex2D( _UberNoiseTexture, ( temp_output_171_0_g12139 * _DirectionalGlowFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g12140 = MyCustomExpression16_g12140( linValue16_g12140 );
				float temp_output_168_0_g12139 = max( ( ( break130_g12139.x + break130_g12139.y + _DirectionalGlowFadeFade + ( localMyCustomExpression16_g12140 * _DirectionalGlowFadeNoiseFactor ) ) / max( _DirectionalGlowFadeWidth , 0.001 ) ) , 0.0 );
				float temp_output_161_0_g12139 = step( 0.1 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g12139 ) ):( temp_output_168_0_g12139 )) );
				float4 temp_output_1_0_g12139 = staticSwitch11_g12134;
				float clampResult154_g12139 = clamp( temp_output_161_0_g12139 , 0.0 , 1.0 );
				float4 appendResult3_g12139 = (float4(( ( (_DirectionalGlowFadeEdgeColor).rgb * ( temp_output_161_0_g12139 - step( 1.0 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g12139 ) ):( temp_output_168_0_g12139 )) ) ) ) + (temp_output_1_0_g12139).rgb ) , ( temp_output_1_0_g12139.a * clampResult154_g12139 )));
				#ifdef _ENABLEDIRECTIONALGLOWFADE_ON
				float4 staticSwitch15_g12134 = appendResult3_g12139;
				#else
				float4 staticSwitch15_g12134 = staticSwitch11_g12134;
				#endif
				float4 temp_output_1_0_g12147 = staticSwitch15_g12134;
				float2 temp_output_126_0_g12147 = temp_output_18_0_g12134;
				float temp_output_121_0_g12147 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_126_0_g12147 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
				float2 appendResult11_g12148 = (float2(temp_output_121_0_g12147 , temp_output_121_0_g12147));
				float temp_output_17_0_g12148 = length( ( (( ( abs( temp_output_126_0_g12147 ) * _HalftoneTiling ) % float2( 1,1 ) )*2.0 + -1.0) / appendResult11_g12148 ) );
				float clampResult17_g12147 = clamp( saturate( ( ( 1.0 - temp_output_17_0_g12148 ) / fwidth( temp_output_17_0_g12148 ) ) ) , 0.0 , 1.0 );
				float4 appendResult3_g12147 = (float4((temp_output_1_0_g12147).rgb , ( temp_output_1_0_g12147.a * (( _HalftoneInvert )?( ( 1.0 - clampResult17_g12147 ) ):( clampResult17_g12147 )) )));
				#ifdef _ENABLEHALFTONE_ON
				float4 staticSwitch13_g12134 = appendResult3_g12147;
				#else
				float4 staticSwitch13_g12134 = staticSwitch15_g12134;
				#endif
				float3 temp_output_3_0_g12150 = (_AddColorColor).rgb;
				float2 uv_AddColorMask = IN.texcoord.xy * _AddColorMask_ST.xy + _AddColorMask_ST.zw;
				float4 tex2DNode19_g12150 = tex2D( _AddColorMask, uv_AddColorMask );
				#ifdef _ADDCOLORMASKTOGGLE_ON
				float3 staticSwitch16_g12150 = ( temp_output_3_0_g12150 * ( (tex2DNode19_g12150).rgb * tex2DNode19_g12150.a ) );
				#else
				float3 staticSwitch16_g12150 = temp_output_3_0_g12150;
				#endif
				float4 temp_output_1_0_g12150 = staticSwitch13_g12134;
				float4 break2_g12152 = temp_output_1_0_g12150;
				#ifdef _ADDCOLORCONTRASTTOGGLE_ON
				float3 staticSwitch17_g12150 = ( staticSwitch16_g12150 * pow( max( ( ( break2_g12152.x + break2_g12152.x + break2_g12152.y + break2_g12152.y + break2_g12152.y + break2_g12152.z ) / 6.0 ) , 0.0001 ) , max( _AddColorContrast , 0.0001 ) ) );
				#else
				float3 staticSwitch17_g12150 = staticSwitch16_g12150;
				#endif
				float4 appendResult6_g12150 = (float4(( ( staticSwitch17_g12150 * _AddColorFade ) + (temp_output_1_0_g12150).rgb ) , temp_output_1_0_g12150.a));
				#ifdef _ENABLEADDCOLOR_ON
				float4 staticSwitch5_g12149 = appendResult6_g12150;
				#else
				float4 staticSwitch5_g12149 = staticSwitch13_g12134;
				#endif
				float4 temp_output_1_0_g12153 = staticSwitch5_g12149;
				float3 lerpResult4_g12153 = lerp( (temp_output_1_0_g12153).rgb , (_AlphaTintColor).rgb , ( ( 1.0 - temp_output_1_0_g12153.a ) * step( _AlphaTintMinAlpha , temp_output_1_0_g12153.a ) * _AlphaTintFade ));
				float4 appendResult13_g12153 = (float4(lerpResult4_g12153 , temp_output_1_0_g12153.a));
				#ifdef _ENABLEALPHATINT_ON
				float4 staticSwitch11_g12149 = appendResult13_g12153;
				#else
				float4 staticSwitch11_g12149 = staticSwitch5_g12149;
				#endif
				float4 temp_output_1_0_g12154 = staticSwitch11_g12149;
				float3 temp_output_6_0_g12154 = (_StrongTintTint).rgb;
				float2 uv_StrongTintMask = IN.texcoord.xy * _StrongTintMask_ST.xy + _StrongTintMask_ST.zw;
				float4 tex2DNode23_g12154 = tex2D( _StrongTintMask, uv_StrongTintMask );
				#ifdef _STRONGTINTMASKTOGGLE_ON
				float3 staticSwitch21_g12154 = ( temp_output_6_0_g12154 * ( (tex2DNode23_g12154).rgb * tex2DNode23_g12154.a ) );
				#else
				float3 staticSwitch21_g12154 = temp_output_6_0_g12154;
				#endif
				float4 break2_g12156 = temp_output_1_0_g12154;
				#ifdef _STRONGTINTCONTRASTTOGGLE_ON
				float3 staticSwitch22_g12154 = ( pow( max( ( ( break2_g12156.x + break2_g12156.x + break2_g12156.y + break2_g12156.y + break2_g12156.y + break2_g12156.z ) / 6.0 ) , 0.0001 ) , max( _StrongTintContrast , 0.0001 ) ) * staticSwitch21_g12154 );
				#else
				float3 staticSwitch22_g12154 = staticSwitch21_g12154;
				#endif
				float3 lerpResult7_g12154 = lerp( (temp_output_1_0_g12154).rgb , staticSwitch22_g12154 , _StrongTintFade);
				float4 appendResult9_g12154 = (float4(lerpResult7_g12154 , (temp_output_1_0_g12154).a));
				#ifdef _ENABLESTRONGTINT_ON
				float4 staticSwitch7_g12149 = appendResult9_g12154;
				#else
				float4 staticSwitch7_g12149 = staticSwitch11_g12149;
				#endif
				float4 temp_output_2_0_g12157 = staticSwitch7_g12149;
				float4 break4_g12159 = temp_output_2_0_g12157;
				float3 appendResult5_g12159 = (float3(break4_g12159.r , break4_g12159.g , break4_g12159.b));
				float2 appendResult10_g12158 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 appendResult2_g12158 = (float2(1.0 , ( _MainTex_TexelSize.z / _MainTex_TexelSize.w )));
				#ifdef _RESIZABLETEXTURE_ON
				float2 staticSwitch9_g12158 = appendResult2_g12158;
				#else
				float2 staticSwitch9_g12158 = ( float2( 100,100 ) / appendResult10_g12158 );
				#endif
				float4 appendResult85_g12157 = (float4(_ShadowColor.r , _ShadowColor.g , _ShadowColor.b , ( _ShadowFade * tex2D( _MainTex, ( finalUV146 - ( staticSwitch9_g12158 * _ShadowOffset ) ) ).a )));
				float4 break6_g12159 = appendResult85_g12157;
				float3 appendResult7_g12159 = (float3(break6_g12159.r , break6_g12159.g , break6_g12159.b));
				float temp_output_11_0_g12159 = ( ( 1.0 - break4_g12159.a ) * break6_g12159.a );
				float temp_output_32_0_g12159 = ( break4_g12159.a + temp_output_11_0_g12159 );
				float4 appendResult18_g12159 = (float4(( ( ( appendResult5_g12159 * break4_g12159.a ) + ( appendResult7_g12159 * temp_output_11_0_g12159 ) ) * ( 1.0 / max( temp_output_32_0_g12159 , 0.01 ) ) ) , temp_output_32_0_g12159));
				#ifdef _ENABLESHADOW_ON
				float4 staticSwitch82_g12157 = appendResult18_g12159;
				#else
				float4 staticSwitch82_g12157 = temp_output_2_0_g12157;
				#endif
				float4 break4_g12160 = staticSwitch82_g12157;
				#ifdef _ENABLECUSTOMFADE_ON
				float staticSwitch8_g11907 = 1.0;
				#else
				float staticSwitch8_g11907 = IN.color.a;
				#endif
				#ifdef _ENABLESMOKE_ON
				float staticSwitch9_g11907 = 1.0;
				#else
				float staticSwitch9_g11907 = staticSwitch8_g11907;
				#endif
				float customVertexAlpha193 = staticSwitch9_g11907;
				float4 appendResult5_g12160 = (float4(break4_g12160.r , break4_g12160.g , break4_g12160.b , ( break4_g12160.a * customVertexAlpha193 )));
				float4 temp_output_344_0 = appendResult5_g12160;
				float4 temp_output_1_0_g12161 = temp_output_344_0;
				float4 appendResult8_g12161 = (float4(( (temp_output_1_0_g12161).rgb * (IN.color).rgb ) , temp_output_1_0_g12161.a));
				#ifdef _VERTEXTINTFIRST_ON
				float4 staticSwitch342 = temp_output_344_0;
				#else
				float4 staticSwitch342 = appendResult8_g12161;
				#endif
				...
				float4 staticSwitch143 = staticSwitch342;
				#endif
				float4 temp_output_7_0_g12168 = staticSwitch143;
				float4 appendResult2_g12168 = (float4(( (temp_output_7_0_g12168).rgb / max( temp_output_7_0_g12168.a , 1E-05 ) ) , temp_output_7_0_g12168.a));
				#ifdef _BAKEDMATERIAL_ON
				float4 staticSwitch6_g12168 = appendResult2_g12168;
				#else
				float4 staticSwitch6_g12168 = temp_output_7_0_g12168;
				#endif
				
				fixed4 c = staticSwitch6_g12168;
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;489;-1990.589,-315.832;Inherit;False;_UberSample;580;;11874;1028d755b36e2b04da25c3b882a2e2ec;0;2;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;231;4899.456,2440.854;Inherit;False;_UberSpreadFade;-1;;11894;777ca8ab10170fb48b24b7cd1c44f075;0;7;27;FLOAT2;0,0;False;22;FLOAT;0;False;18;SAMPLER2D;0;False;25;FLOAT2;0,0;False;23;FLOAT2;0,0;False;21;FLOAT;0;False;26;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;223;4905.316,1828.167;Inherit;False;_UberDissolveFade;-1;;11896;cb957eb9b67f4f243aa8ba0547208263;0;5;21;FLOAT2;0,0;False;1;FLOAT;0;False;16;SAMPLER2D;0;False;18;FLOAT2;0,0;False;20;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;292;5091.561,1459.408;Inherit;False;ShaderMasker;-1;;11898;3d25b55dbfdd24f48b9bd371bdde0e97;0;2;1;FLOAT;0;False;2;SAMPLER2D;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;341;2716.61,1541.034;Inherit;False;ShaderTime;25;;11899;06a15e67904f217499045f361bad56e7;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;439;3389.449,1182.896;Inherit;False;ShaderSpace;9;;11900;be729ef05db9c224caec82a3516038dc;0;2;61;FLOAT2;0,0;False;3;SAMPLER2D;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;1839.482,-2552.931;Inherit;False;_HologramUV;213;;11901;7c71b1b031ffcbe48805e17b94671163;0;7;77;FLOAT;0;False;55;FLOAT;0;False;76;SAMPLER2D;;False;37;FLOAT2;0,0;False;39;SAMPLER2D;;False;81;FLOAT;0;False;79;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;103;2715.721,-2556.586;Inherit;False;_GlitchUV;234;;11905;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;343;-737.796,35.8288;Inherit;False;_UberCustomAlpha;591;;11907;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;FLOAT;12;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;239;-404.7228,-125.1053;Inherit;False;_UberGenerated;565;;11912;52defa3f7cca25740a6a77f065edb382;0;4;10;FLOAT;0;False;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;484;3382.41,-2373.518;Inherit;False;_UberTransformUV;479;;11916;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;378;5475.994,-2043.135;Inherit;False;Remap2D;-1;;11928;f79f855c0a5c94649b58f3d8127375ae;0;5;13;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;1,1;False;5;FLOAT2;0,0;False;6;FLOAT2;1,1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;492;-136.8644,-329.1863;Inherit;False;_UberColor;66;;12026;db48f560e502b78409f7fbe481a93597;0;6;39;FLOAT;0;False;40;FLOAT2;0,0;False;1;FLOAT2;0,0;False;24;SAMPLER2D;0;False;3;COLOR;0,0,0,0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;51;183.7499,-168.0946;Inherit;False;_Hologram;206;;12068;76082a965d84d0e4da33b2cff51b3691;0;5;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;43;FLOAT;0;False;44;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;104;973.7388,-316.5438;Inherit;False;_Glitch;228;;12071;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;470;6618.802,-2035.91;Inherit;False;_PixelArtUV_2;-1;;12075;4b65626ba2313ca40a96813b19044794;0;4;21;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;473;1656.25,-345.9998;Inherit;False;_UberEffect;239;;12076;93c7a07f758a0814998210619e8ad1cb;0;4;40;FLOAT;0;False;41;FLOAT2;0,0;False;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;78;2104.106,-267.8359;Inherit;False;AlphaMultiply;-1;;12132;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;76;3014.405,-219.2272;Inherit;False;AlphaMultiply;-1;;12133;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;248;3912.165,-179.9706;Inherit;False;_UberFading;402;;12134;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;478;4200.417,-206.2577;Inherit;False;_UberColorFinal;37;;12149;6ac57aba23ea6404ba71b6806ea93971;0;3;14;FLOAT2;0,0;False;15;SAMPLER2D;;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;344;4548.086,-90.46628;Inherit;False;AlphaMultiply;-1;;12160;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;353;4889.3,-222.093;Inherit;False;ColorMultiply;-1;;12161;1f51da7edd80c06488c56d28bc096dec;0;2;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;199;4171.966,521.7499;Inherit;False;_Squish;560;;12162;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;195;4877.096,136.7432;Inherit;False;TintVertex;-1;;12163;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;424;4759.72,401.6135;Inherit;False;_UberTransformOffset;526;;12164;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;491;6010.595,-19.64009;Inherit;False;BakingHandler;6;;12168;f63dfe0dc7c747c43b593d357b168fa0;0;1;7;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=1F27540BC852F6F02EDAA7459EC6912011075AA9