...
Shader "Sprite Shaders Ultimate/Additive SSU"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			float MyCustomExpression16_g11769( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float3 MyCustomExpression115_g11793( float3 In, float3 From, float3 To, float Fuzziness, float Range )
			{
			...
			float2 MyCustomExpression10_g11892( float2 UV, int Width, int Height, float Tile, float2 Invert )
			{
			...
			float2 MyCustomExpression10_g11888( float2 UV, int Width, int Height, float Tile, float2 Invert )
			{
				Tile = fmod(Tile + 0.001, Width * Height);
				float2 tileCount = float2(1, 1) / float2(Width, Height);
				float tileY = abs(Invert.y * Height - (floor(Tile * tileCount.x) + Invert.y * 1));
			...
			float MyCustomExpression16_g11899( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g11907( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g11905( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g11901( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g11903( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			v2f vert( appdata_t IN  )
			{
				...
				float2 break77_g11924 = fixedUV475;
				float2 appendResult72_g11924 = (float2(( _SquishStretch * ( break77_g11924.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g11924.y + _SquishFlip ) * -_SquishSquish )));
				#ifdef _ENABLESQUISH_ON
				float2 staticSwitch198 = ( appendResult72_g11924 + _ZeroVector );
				#else
				float2 staticSwitch198 = _ZeroVector;
				#endif
				float2 temp_output_2_0_g11927 = staticSwitch198;
				#ifdef _TOGGLECUSTOMTIME_ON
				float staticSwitch44_g11759 = _TimeValue;
				#else
				float staticSwitch44_g11759 = _Time.y;
				#endif
				#ifdef _TOGGLEUNSCALEDTIME_ON
				float staticSwitch34_g11759 = UnscaledTime;
				#else
				float staticSwitch34_g11759 = staticSwitch44_g11759;
				#endif
				#ifdef _TOGGLETIMESPEED_ON
				float staticSwitch37_g11759 = ( staticSwitch34_g11759 * _TimeSpeed );
				#else
				float staticSwitch37_g11759 = staticSwitch34_g11759;
				#endif
				#ifdef _TOGGLETIMEFPS_ON
				float staticSwitch38_g11759 = ( floor( ( staticSwitch37_g11759 * _TimeFPS ) ) / _TimeFPS );
				#else
				float staticSwitch38_g11759 = staticSwitch37_g11759;
				#endif
				#ifdef _TOGGLETIMEFREQUENCY_ON
				float staticSwitch42_g11759 = ( ( sin( ( staticSwitch38_g11759 * _TimeFrequency ) ) * _TimeRange ) + 100.0 );
				#else
				float staticSwitch42_g11759 = staticSwitch38_g11759;
				#endif
				float shaderTime237 = staticSwitch42_g11759;
				float temp_output_8_0_g11927 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g11927 = ( ( sin( ( temp_output_8_0_g11927 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g11927 );
				#else
				float2 staticSwitch4_g11927 = temp_output_2_0_g11927;
				#endif
				float temp_output_30_0_g11928 = temp_output_8_0_g11927;
				float3 rotatedValue21_g11928 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g11928 * _VibrateRotation ) );
				#ifdef _ENABLEVIBRATE_ON
				float2 staticSwitch6_g11927 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g11928 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g11928).xy ) + staticSwitch4_g11927 );
				#else
				float2 staticSwitch6_g11927 = staticSwitch4_g11927;
				#endif
				#ifdef _ENABLESINESCALE_ON
				float2 staticSwitch10_g11927 = ( staticSwitch6_g11927 + ( (IN.vertex.xyz).xy * ( ( ( sin( ( _SineScaleFrequency * temp_output_8_0_g11927 ) ) + 1.0 ) * 0.5 ) * _SineScaleFactor ) ) );
				#else
				float2 staticSwitch10_g11927 = staticSwitch6_g11927;
				#endif
				float2 temp_output_424_0 = staticSwitch10_g11927;
				float2 uv_FadingMask = IN.texcoord.xy * _FadingMask_ST.xy + _FadingMask_ST.zw;
				float4 tex2DNode3_g11754 = tex2Dlod( _FadingMask, float4( uv_FadingMask, 0, 0.0) );
				...
				#endif
				float2 temp_output_61_0_g11760 = staticSwitch437;
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float2 texCoord23_g11760 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult28_g11760 = (float2(_RectWidth , _RectHeight));
				#if defined( _SHADERSPACE_UV )
				float2 staticSwitch1_g11760 = ( temp_output_61_0_g11760 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#elif defined( _SHADERSPACE_UV_RAW )
				float2 staticSwitch1_g11760 = temp_output_61_0_g11760;
				#elif defined( _SHADERSPACE_OBJECT )
				float2 staticSwitch1_g11760 = (IN.vertex.xyz).xy;
				#elif defined( _SHADERSPACE_OBJECT_SCALED )
				float2 staticSwitch1_g11760 = ( (IN.vertex.xyz).xy * (ase_objectScale).xy );
				#elif defined( _SHADERSPACE_WORLD )
				float2 staticSwitch1_g11760 = (ase_positionWS).xy;
				#elif defined( _SHADERSPACE_UI_GRAPHIC )
				float2 staticSwitch1_g11760 = ( texCoord23_g11760 * ( appendResult28_g11760 / _PixelsPerUnit ) );
				#elif defined( _SHADERSPACE_SCREEN )
				float2 staticSwitch1_g11760 = ( ( (ase_positionSSNorm).xy * (_ScreenParams).xy ) / ( _ScreenParams.x / _ScreenWidthUnits ) );
				#else
				float2 staticSwitch1_g11760 = ( temp_output_61_0_g11760 / ( _PixelsPerUnit * (_MainTex_TexelSize).xy ) );
				#endif
				float2 temp_output_70_0_g11760 = ( _ShaderSpaceOffset + staticSwitch1_g11760 );
				#ifdef _SHADERSPACEPIXELATE_ON
				float2 staticSwitch63_g11760 = ( floor( ( temp_output_70_0_g11760 * _ShaderSpacePixelation ) ) / _ShaderSpacePixelation );
				#else
				float2 staticSwitch63_g11760 = temp_output_70_0_g11760;
				#endif
				float2 shaderPosition235 = staticSwitch63_g11760;
				...
				float staticSwitch139 = ( _FadingFade * ( tex2DNode3_g11754.r * tex2DNode3_g11754.a ) );
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 staticSwitch1_g11760 = temp_output_61_0_g11760;
				#elif defined( _SHADERSPACE_OBJECT )
				float2 staticSwitch1_g11760 = (IN.ase_texcoord3.xyz).xy;
				#elif defined( _SHADERSPACE_OBJECT_SCALED )
				float2 staticSwitch1_g11760 = ( (IN.ase_texcoord3.xyz).xy * (ase_objectScale).xy );
				#elif defined( _SHADERSPACE_WORLD )
				float2 staticSwitch1_g11760 = (ase_positionWS).xy;
				#elif defined( _SHADERSPACE_UI_GRAPHIC )
				float2 staticSwitch1_g11760 = ( texCoord23_g11760 * ( appendResult28_g11760 / _PixelsPerUnit ) );
				...
				#endif
				float temp_output_81_0_g11761 = unity_OrthoParams.y;
				float temp_output_8_0_g11761 = ( ( ( shaderTime237 * ( _HologramDistortionSpeed * temp_output_81_0_g11761 * 0.2 ) ) + ase_positionWS.y ) / temp_output_81_0_g11761 );
				float2 temp_cast_4 = (temp_output_8_0_g11761).xx;
				float2 temp_cast_5 = (_HologramDistortionDensity).xx;
				float linValue16_g11763 = tex2D( _UberNoiseTexture, ( temp_cast_4 * temp_cast_5 ) ).r;
				float localMyCustomExpression16_g11763 = MyCustomExpression16_g11763( linValue16_g11763 );
				float clampResult75_g11761 = clamp( localMyCustomExpression16_g11763 , 0.075 , 0.6 );
				float2 temp_cast_6 = (temp_output_8_0_g11761).xx;
				float2 temp_cast_7 = (_HologramDistortionScale).xx;
				float linValue16_g11764 = tex2D( _UberNoiseTexture, ( temp_cast_6 * temp_cast_7 ) ).r;
				float localMyCustomExpression16_g11764 = MyCustomExpression16_g11764( linValue16_g11764 );
				float2 appendResult10_g11762 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 appendResult2_g11762 = (float2(1.0 , ( _MainTex_TexelSize.z / _MainTex_TexelSize.w )));
				#ifdef _RESIZABLETEXTURE_ON
				float2 staticSwitch9_g11762 = appendResult2_g11762;
				#else
				float2 staticSwitch9_g11762 = ( float2( 100,100 ) / appendResult10_g11762 );
				#endif
				float hologramFade182 = _HologramFade;
				float2 appendResult44_g11761 = (float2(( ( ( clampResult75_g11761 * ( localMyCustomExpression16_g11764 - 0.5 ) ) * _HologramDistortionOffset * staticSwitch9_g11762.x ) * hologramFade182 ) , 0.0));
				#ifdef _ENABLEHOLOGRAM_ON
				float2 staticSwitch59 = ( staticSwitch82 + appendResult44_g11761 );
				#else
				...
				float linValue16_g11766 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchDistortionSpeed * shaderTime237 ) ) * _GlitchDistortionScale ) ).r;
				...
				float2 staticSwitch62 = ( staticSwitch59 + ( ( localMyCustomExpression16_g11766 - 0.5 ) * _GlitchDistortion * glitchFade152 ) );
				#else
				...
				float2 appendResult10_g11785 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 appendResult2_g11785 = (float2(1.0 , ( _MainTex_TexelSize.z / _MainTex_TexelSize.w )));
				#ifdef _RESIZABLETEXTURE_ON
				float2 staticSwitch9_g11785 = appendResult2_g11785;
				#else
				float2 staticSwitch9_g11785 = ( float2( 100,100 ) / appendResult10_g11785 );
				#endif
				...
				float2 staticSwitch5_g11776 = ( temp_output_1_0_g11776 + ( lerpResult21_g11783 * staticSwitch9_g11785 * staticSwitch29_g11783 ) );
				#else
				...
				float2 uv_FadingMask = IN.texcoord.xy * _FadingMask_ST.xy + _FadingMask_ST.zw;
				float4 tex2DNode3_g11754 = tex2D( _FadingMask, uv_FadingMask );
				float temp_output_4_0_g11757 = max( _FadingWidth , 0.001 );
				...
				#endif
				float2 appendResult7_g11838 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				#ifdef _PIXELPERFECTUV_ON
				float2 staticSwitch427 = ( originalUV460 + ( floor( ( ( staticSwitch371 - uvAfterPixelArt450 ) * appendResult7_g11838 ) ) / appendResult7_g11838 ) );
				#else
				...
				float4 temp_output_1_0_g11767 = originalColor191;
				float4 temp_output_1_0_g11768 = temp_output_1_0_g11767;
				float2 temp_output_7_0_g11767 = finalUV146;
				float2 temp_output_43_0_g11768 = temp_output_7_0_g11767;
				float2 temp_cast_15 = (_SmokeNoiseScale).xx;
				float linValue16_g11769 = tex2D( _UberNoiseTexture, ( ( ( IN.color.r * (( _SmokeVertexSeed )?( 5.0 ):( 0.0 )) ) + temp_output_43_0_g11768 ) * temp_cast_15 ) ).r;
				float localMyCustomExpression16_g11769 = MyCustomExpression16_g11769( linValue16_g11769 );
				float clampResult28_g11768 = clamp( ( ( ( localMyCustomExpression16_g11769 - 1.0 ) * _SmokeNoiseFactor ) + ( ( ( IN.color.a / 2.5 ) - distance( temp_output_43_0_g11768 , float2( 0.5,0.5 ) ) ) * 2.5 * _SmokeSmoothness ) ) , 0.0 , 1.0 );
				float3 lerpResult34_g11768 = lerp( (temp_output_1_0_g11768).rgb , float3( 0,0,0 ) , ( ( 1.0 - clampResult28_g11768 ) * _SmokeDarkEdge ));
				float4 appendResult31_g11768 = (float4(lerpResult34_g11768 , ( clampResult28_g11768 * _SmokeAlpha * temp_output_1_0_g11768.a )));
				#ifdef _ENABLESMOKE_ON
				float4 staticSwitch2_g11767 = appendResult31_g11768;
				#else
				float4 staticSwitch2_g11767 = temp_output_1_0_g11767;
				#endif
				float4 temp_output_1_0_g11770 = staticSwitch2_g11767;
				float2 temp_output_57_0_g11770 = temp_output_7_0_g11767;
				float4 tex2DNode3_g11770 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g11770 );
				float linValue16_g11771 = tex2D( _UberNoiseTexture, ( temp_output_57_0_g11770 * _CustomFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11771 = MyCustomExpression16_g11771( linValue16_g11771 );
				float clampResult37_g11770 = clamp( ( ( ( IN.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g11770.r + ( localMyCustomExpression16_g11771 * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g11770 = (float4((temp_output_1_0_g11770).rgb , ( temp_output_1_0_g11770.a * pow( clampResult37_g11770 , ( _CustomFadeSmoothness / max( tex2DNode3_g11770.r , 0.05 ) ) ) * _CustomFadeAlpha )));
				#ifdef _ENABLECUSTOMFADE_ON
				float4 staticSwitch3_g11767 = appendResult13_g11770;
				#else
				float4 staticSwitch3_g11767 = staticSwitch2_g11767;
				#endif
				float4 temp_output_1_0_g11772 = staticSwitch3_g11767;
				float4 temp_output_1_0_g11773 = temp_output_1_0_g11772;
				float2 appendResult4_g11773 = (float2(ase_positionWS.x , ase_positionWS.y));
				float2 temp_output_44_0_g11773 = ( appendResult4_g11773 * _CheckerboardTiling * 0.5 );
				float2 break12_g11773 = step( ( ceil( temp_output_44_0_g11773 ) - temp_output_44_0_g11773 ) , float2( 0.5,0.5 ) );
				float4 appendResult42_g11773 = (float4(( (temp_output_1_0_g11773).rgb * min( ( _CheckerboardDarken + abs( ( -break12_g11773.x + break12_g11773.y ) ) ) , 1.0 ) ) , temp_output_1_0_g11773.a));
				#ifdef _ENABLECHECKERBOARD_ON
				float4 staticSwitch2_g11772 = appendResult42_g11773;
				#else
				float4 staticSwitch2_g11772 = temp_output_1_0_g11772;
				#endif
				float2 temp_output_75_0_g11774 = finalUV146;
				float linValue16_g11775 = tex2D( _UberNoiseTexture, ( ( ( shaderTime237 * _FlameSpeed ) + temp_output_75_0_g11774 ) * _FlameNoiseScale ) ).r;
				float localMyCustomExpression16_g11775 = MyCustomExpression16_g11775( linValue16_g11775 );
				float saferPower57_g11774 = abs( max( ( temp_output_75_0_g11774.y - 0.2 ) , 0.0 ) );
				float temp_output_47_0_g11774 = max( _FlameRadius , 0.01 );
				float clampResult70_g11774 = clamp( ( ( ( localMyCustomExpression16_g11775 * pow( saferPower57_g11774 , _FlameNoiseHeightFactor ) * _FlameNoiseFactor ) + ( ( temp_output_47_0_g11774 - distance( temp_output_75_0_g11774 , float2( 0.5,0.4 ) ) ) / temp_output_47_0_g11774 ) ) * _FlameSmooth ) , 0.0 , 1.0 );
				float temp_output_63_0_g11774 = ( clampResult70_g11774 * _FlameBrightness );
				float4 appendResult31_g11774 = (float4(temp_output_63_0_g11774 , temp_output_63_0_g11774 , temp_output_63_0_g11774 , clampResult70_g11774));
				#ifdef _ENABLEFLAME_ON
				float4 staticSwitch6_g11772 = ( appendResult31_g11774 * staticSwitch2_g11772 );
				#else
				float4 staticSwitch6_g11772 = staticSwitch2_g11772;
				#endif
				float4 temp_output_3_0_g11789 = staticSwitch6_g11772;
				float4 temp_output_1_0_g11821 = temp_output_3_0_g11789;
				float4 appendResult91_g11821 = (float4((temp_output_1_0_g11821).rgb , 1.0));
				float2 temp_output_1_0_g11789 = finalUV146;
				#ifdef _RECOLORRGBTEXTURETOGGLE_ON
				float4 staticSwitch81_g11821 = tex2D( _RecolorRGBTexture, temp_output_1_0_g11789 );
				#else
				float4 staticSwitch81_g11821 = appendResult91_g11821;
				#endif
				float3 break82_g11821 = (staticSwitch81_g11821).xyz;
				float temp_output_84_0_g11821 = max( ( break82_g11821.x + break82_g11821.y + break82_g11821.z ) , 0.001 );
				float4 break71_g11821 = ( ( _RecolorRGBRedTint * ( break82_g11821.x / temp_output_84_0_g11821 ) ) + ( _RecolorRGBGreenTint * ( break82_g11821.y / temp_output_84_0_g11821 ) ) + ( ( break82_g11821.z / temp_output_84_0_g11821 ) * _RecolorRGBBlueTint ) );
				float3 appendResult56_g11821 = (float3(break71_g11821.r , break71_g11821.g , break71_g11821.b));
				float4 break2_g11822 = temp_output_1_0_g11821;
				float saferPower57_g11821 = abs( ( ( break2_g11822.x + break2_g11822.x + break2_g11822.y + break2_g11822.y + break2_g11822.y + break2_g11822.z ) / 6.0 ) );
				float3 lerpResult26_g11821 = lerp( (temp_output_1_0_g11821).rgb , ( appendResult56_g11821 * pow( saferPower57_g11821 , ( max( break71_g11821.a , 0.01 ) * 2.0 ) ) ) , ( staticSwitch81_g11821.w * _RecolorRGBFade ));
				float4 appendResult30_g11821 = (float4(lerpResult26_g11821 , temp_output_1_0_g11821.a));
				#ifdef _ENABLERECOLORRGB_ON
				float4 staticSwitch43_g11789 = appendResult30_g11821;
				#else
				float4 staticSwitch43_g11789 = temp_output_3_0_g11789;
				#endif
				float4 temp_output_1_0_g11819 = staticSwitch43_g11789;
				#ifdef _RECOLORRGBYCPTEXTURETOGGLE_ON
				float4 staticSwitch62_g11819 = tex2D( _RecolorRGBYCPTexture, temp_output_1_0_g11789 );
				#else
				float4 staticSwitch62_g11819 = temp_output_1_0_g11819;
				#endif
				float3 hsvTorgb33_g11819 = RGBToHSV( staticSwitch62_g11819.rgb );
				float temp_output_43_0_g11819 = ( ( hsvTorgb33_g11819.x + 0.08333334 ) % 1.0 );
				float4 ifLocalVar46_g11819 = 0;
				if( temp_output_43_0_g11819 >= 0.8333333 )
				ifLocalVar46_g11819 = _RecolorRGBYCPPurpleTint;
				else
				ifLocalVar46_g11819 = _RecolorRGBYCPBlueTint;
				float4 ifLocalVar44_g11819 = 0;
				if( temp_output_43_0_g11819 <= 0.6666667 )
				ifLocalVar44_g11819 = _RecolorRGBYCPCyanTint;
				else
				ifLocalVar44_g11819 = ifLocalVar46_g11819;
				float4 ifLocalVar47_g11819 = 0;
				if( temp_output_43_0_g11819 <= 0.3333333 )
				ifLocalVar47_g11819 = _RecolorRGBYCPYellowTint;
				else
				ifLocalVar47_g11819 = _RecolorRGBYCPGreenTint;
				float4 ifLocalVar45_g11819 = 0;
				if( temp_output_43_0_g11819 <= 0.1666667 )
				ifLocalVar45_g11819 = _RecolorRGBYCPRedTint;
				else
				ifLocalVar45_g11819 = ifLocalVar47_g11819;
				float4 ifLocalVar35_g11819 = 0;
				if( temp_output_43_0_g11819 >= 0.5 )
				ifLocalVar35_g11819 = ifLocalVar44_g11819;
				else
				ifLocalVar35_g11819 = ifLocalVar45_g11819;
				float4 break55_g11819 = ifLocalVar35_g11819;
				float3 appendResult56_g11819 = (float3(break55_g11819.r , break55_g11819.g , break55_g11819.b));
				float4 break2_g11820 = temp_output_1_0_g11819;
				float saferPower57_g11819 = abs( ( ( break2_g11820.x + break2_g11820.x + break2_g11820.y + break2_g11820.y + break2_g11820.y + break2_g11820.z ) / 6.0 ) );
				float3 lerpResult26_g11819 = lerp( (temp_output_1_0_g11819).rgb , ( appendResult56_g11819 * pow( saferPower57_g11819 , max( ( break55_g11819.a * 2.0 ) , 0.01 ) ) ) , ( hsvTorgb33_g11819.z * _RecolorRGBYCPFade ));
				float4 appendResult30_g11819 = (float4(lerpResult26_g11819 , temp_output_1_0_g11819.a));
				#ifdef _ENABLERECOLORRGBYCP_ON
				float4 staticSwitch9_g11789 = appendResult30_g11819;
				#else
				float4 staticSwitch9_g11789 = staticSwitch43_g11789;
				#endif
				float4 temp_output_1_0_g11793 = staticSwitch9_g11789;
				float3 temp_output_2_0_g11793 = (temp_output_1_0_g11793).rgb;
				float3 In115_g11793 = temp_output_2_0_g11793;
				float3 From115_g11793 = (_ColorReplaceFromColor).rgb;
				float4 break2_g11794 = temp_output_1_0_g11793;
				float3 To115_g11793 = ( pow( max( ( ( break2_g11794.x + break2_g11794.x + break2_g11794.y + break2_g11794.y + break2_g11794.y + break2_g11794.z ) / 6.0 ) , 0.0001 ) , max( _ColorReplaceContrast , 0.0001 ) ) * (_ColorReplaceToColor).rgb );
				float Fuzziness115_g11793 = _ColorReplaceSmoothness;
				float Range115_g11793 = _ColorReplaceRange;
				float3 localMyCustomExpression115_g11793 = MyCustomExpression115_g11793( In115_g11793 , From115_g11793 , To115_g11793 , Fuzziness115_g11793 , Range115_g11793 );
				float3 lerpResult112_g11793 = lerp( temp_output_2_0_g11793 , localMyCustomExpression115_g11793 , _ColorReplaceFade);
				float4 appendResult4_g11793 = (float4(lerpResult112_g11793 , temp_output_1_0_g11793.a));
				#ifdef _ENABLECOLORREPLACE_ON
				float4 staticSwitch29_g11789 = appendResult4_g11793;
				#else
				float4 staticSwitch29_g11789 = staticSwitch9_g11789;
				#endif
				float4 temp_output_1_0_g11806 = staticSwitch29_g11789;
				float3 temp_output_9_0_g11806 = (temp_output_1_0_g11806).rgb;
				float3 lerpResult3_g11806 = lerp( temp_output_9_0_g11806 , ( 1.0 - temp_output_9_0_g11806 ) , _NegativeFade);
				float4 appendResult8_g11806 = (float4(lerpResult3_g11806 , temp_output_1_0_g11806.a));
				#ifdef _ENABLENEGATIVE_ON
				float4 staticSwitch4_g11806 = appendResult8_g11806;
				#else
				float4 staticSwitch4_g11806 = temp_output_1_0_g11806;
				#endif
				float4 temp_output_57_0_g11789 = staticSwitch4_g11806;
				float4 temp_output_1_0_g11829 = temp_output_57_0_g11789;
				float3 temp_cast_30 = (max( _Contrast , 0.0001 )).xxx;
				float4 appendResult4_g11829 = (float4(pow( max( (temp_output_1_0_g11829).rgb , float3( 0.0001,0.0001,0.0001 ) ) , temp_cast_30 ) , temp_output_1_0_g11829.a));
				#ifdef _ENABLECONTRAST_ON
				float4 staticSwitch32_g11789 = appendResult4_g11829;
				#else
				float4 staticSwitch32_g11789 = temp_output_57_0_g11789;
				#endif
				float4 temp_output_2_0_g11804 = staticSwitch32_g11789;
				float4 appendResult6_g11804 = (float4(( (temp_output_2_0_g11804).rgb * _Brightness ) , temp_output_2_0_g11804.a));
				#ifdef _ENABLEBRIGHTNESS_ON
				float4 staticSwitch33_g11789 = appendResult6_g11804;
				#else
				float4 staticSwitch33_g11789 = staticSwitch32_g11789;
				#endif
				float4 temp_output_2_0_g11805 = staticSwitch33_g11789;
				float3 hsvTorgb1_g11805 = RGBToHSV( temp_output_2_0_g11805.rgb );
				float3 hsvTorgb3_g11805 = HSVToRGB( float3(( hsvTorgb1_g11805.x + _Hue ),hsvTorgb1_g11805.y,hsvTorgb1_g11805.z) );
				float4 appendResult8_g11805 = (float4(hsvTorgb3_g11805 , temp_output_2_0_g11805.a));
				#ifdef _ENABLEHUE_ON
				float4 staticSwitch36_g11789 = appendResult8_g11805;
				#else
				float4 staticSwitch36_g11789 = staticSwitch33_g11789;
				#endif
				float4 temp_output_1_0_g11823 = staticSwitch36_g11789;
				float4 break2_g11824 = temp_output_1_0_g11823;
				float temp_output_3_0_g11823 = ( ( break2_g11824.x + break2_g11824.x + break2_g11824.y + break2_g11824.y + break2_g11824.y + break2_g11824.z ) / 6.0 );
				float clampResult25_g11823 = clamp( ( ( ( ( temp_output_3_0_g11823 + _SplitToningShift ) - 0.5 ) * _SplitToningBalance ) + 0.5 ) , 0.0 , 1.0 );
				float3 lerpResult6_g11823 = lerp( (_SplitToningShadowsColor).rgb , (_SplitToningHighlightsColor).rgb , clampResult25_g11823);
				float3 lerpResult11_g11823 = lerp( (temp_output_1_0_g11823).rgb , ( lerpResult6_g11823 * pow( max( temp_output_3_0_g11823 , 0.0001 ) , max( _SplitToningContrast , 0.0001 ) ) ) , _SplitToningFade);
				float4 appendResult18_g11823 = (float4(lerpResult11_g11823 , temp_output_1_0_g11823.a));
				#ifdef _ENABLESPLITTONING_ON
				float4 staticSwitch30_g11789 = appendResult18_g11823;
				#else
				float4 staticSwitch30_g11789 = staticSwitch36_g11789;
				#endif
				float4 temp_output_1_0_g11801 = staticSwitch30_g11789;
				float3 temp_output_4_0_g11801 = (temp_output_1_0_g11801).rgb;
				float4 break12_g11801 = temp_output_1_0_g11801;
				float3 lerpResult7_g11801 = lerp( temp_output_4_0_g11801 , ( temp_output_4_0_g11801 + (_BlackTintColor).rgb ) , pow( max( ( 1.0 - min( max( max( break12_g11801.r , break12_g11801.g ) , break12_g11801.b ) , 1.0 ) ) , 0.0001 ) , max( _BlackTintPower , 0.0001 ) ));
				float3 lerpResult13_g11801 = lerp( temp_output_4_0_g11801 , lerpResult7_g11801 , _BlackTintFade);
				float4 appendResult11_g11801 = (float4(lerpResult13_g11801 , break12_g11801.a));
				#ifdef _ENABLEBLACKTINT_ON
				float4 staticSwitch20_g11789 = appendResult11_g11801;
				#else
				float4 staticSwitch20_g11789 = staticSwitch30_g11789;
				#endif
				float4 temp_output_1_0_g11815 = staticSwitch20_g11789;
				float4 break2_g11817 = temp_output_1_0_g11815;
				float2 temp_output_65_0_g11815 = shaderPosition235;
				float linValue16_g11816 = tex2D( _UberNoiseTexture, ( temp_output_65_0_g11815 * _InkSpreadNoiseScale ) ).r;
				float localMyCustomExpression16_g11816 = MyCustomExpression16_g11816( linValue16_g11816 );
				float clampResult53_g11815 = clamp( ( ( ( _InkSpreadDistance - distance( _InkSpreadPosition , temp_output_65_0_g11815 ) ) + ( localMyCustomExpression16_g11816 * _InkSpreadNoiseFactor ) ) / max( _InkSpreadWidth , 0.001 ) ) , 0.0 , 1.0 );
				float3 lerpResult7_g11815 = lerp( (temp_output_1_0_g11815).rgb , ( (_InkSpreadColor).rgb * pow( max( ( ( break2_g11817.x + break2_g11817.x + break2_g11817.y + break2_g11817.y + break2_g11817.y + break2_g11817.z ) / 6.0 ) , 0.0001 ) , max( _InkSpreadContrast , 0.0001 ) ) ) , ( _InkSpreadFade * clampResult53_g11815 ));
				float4 appendResult9_g11815 = (float4(lerpResult7_g11815 , (temp_output_1_0_g11815).a));
				#ifdef _ENABLEINKSPREAD_ON
				float4 staticSwitch17_g11789 = appendResult9_g11815;
				#else
				float4 staticSwitch17_g11789 = staticSwitch20_g11789;
				#endif
				float temp_output_39_0_g11789 = shaderTime237;
				float4 temp_output_1_0_g11807 = staticSwitch17_g11789;
				float3 hsvTorgb15_g11807 = RGBToHSV( (temp_output_1_0_g11807).rgb );
				float3 hsvTorgb19_g11807 = HSVToRGB( float3(( ( temp_output_39_0_g11789 * _ShiftHueSpeed ) + hsvTorgb15_g11807.x ),hsvTorgb15_g11807.y,hsvTorgb15_g11807.z) );
				float4 appendResult6_g11807 = (float4(hsvTorgb19_g11807 , temp_output_1_0_g11807.a));
				#ifdef _ENABLESHIFTHUE_ON
				float4 staticSwitch19_g11789 = appendResult6_g11807;
				#else
				float4 staticSwitch19_g11789 = staticSwitch17_g11789;
				#endif
				float3 hsvTorgb19_g11811 = HSVToRGB( float3(( ( temp_output_39_0_g11789 * _AddHueSpeed ) % 1.0 ),_AddHueSaturation,_AddHueBrightness) );
				float4 temp_output_1_0_g11811 = staticSwitch19_g11789;
				float4 break2_g11813 = temp_output_1_0_g11811;
				float2 uv_AddHueMask = IN.texcoord.xy * _AddHueMask_ST.xy + _AddHueMask_ST.zw;
				float4 tex2DNode3_g11812 = tex2D( _AddHueMask, uv_AddHueMask );
				#ifdef _ADDHUEMASKTOGGLE_ON
				float staticSwitch33_g11811 = ( _AddHueFade * ( tex2DNode3_g11812.r * tex2DNode3_g11812.a ) );
				#else
				float staticSwitch33_g11811 = _AddHueFade;
				#endif
				float4 appendResult6_g11811 = (float4(( ( hsvTorgb19_g11811 * pow( max( ( ( break2_g11813.x + break2_g11813.x + break2_g11813.y + break2_g11813.y + break2_g11813.y + break2_g11813.z ) / 6.0 ) , 0.0001 ) , max( _AddHueContrast , 0.0001 ) ) * staticSwitch33_g11811 ) + (temp_output_1_0_g11811).rgb ) , temp_output_1_0_g11811.a));
				#ifdef _ENABLEADDHUE_ON
				float4 staticSwitch23_g11789 = appendResult6_g11811;
				#else
				float4 staticSwitch23_g11789 = staticSwitch19_g11789;
				#endif
				float4 temp_output_1_0_g11808 = staticSwitch23_g11789;
				float4 break2_g11809 = temp_output_1_0_g11808;
				float3 temp_output_13_0_g11808 = (_SineGlowColor).rgb;
				float2 uv_SineGlowMask = IN.texcoord.xy * _SineGlowMask_ST.xy + _SineGlowMask_ST.zw;
				float4 tex2DNode30_g11808 = tex2D( _SineGlowMask, uv_SineGlowMask );
				#ifdef _SINEGLOWMASKTOGGLE_ON
				float3 staticSwitch27_g11808 = ( (tex2DNode30_g11808).rgb * temp_output_13_0_g11808 * tex2DNode30_g11808.a );
				#else
				float3 staticSwitch27_g11808 = temp_output_13_0_g11808;
				#endif
				float4 appendResult21_g11808 = (float4(( (temp_output_1_0_g11808).rgb + ( pow( max( ( ( break2_g11809.x + break2_g11809.x + break2_g11809.y + break2_g11809.y + break2_g11809.y + break2_g11809.z ) / 6.0 ) , 0.0001 ) , max( _SineGlowContrast , 0.0001 ) ) * staticSwitch27_g11808 * _SineGlowFade * ( ( ( sin( ( temp_output_39_0_g11789 * _SineGlowFrequency ) ) + 1.0 ) * ( _SineGlowMax - _SineGlowMin ) ) + _SineGlowMin ) ) ) , temp_output_1_0_g11808.a));
				#ifdef _ENABLESINEGLOW_ON
				float4 staticSwitch28_g11789 = appendResult21_g11808;
				#else
				float4 staticSwitch28_g11789 = staticSwitch23_g11789;
				#endif
				float4 temp_output_1_0_g11796 = staticSwitch28_g11789;
				float4 break2_g11797 = temp_output_1_0_g11796;
				float3 temp_cast_46 = (( ( break2_g11797.x + break2_g11797.x + break2_g11797.y + break2_g11797.y + break2_g11797.y + break2_g11797.z ) / 6.0 )).xxx;
				float3 lerpResult5_g11796 = lerp( temp_cast_46 , (temp_output_1_0_g11796).rgb , _Saturation);
				float4 appendResult8_g11796 = (float4(lerpResult5_g11796 , temp_output_1_0_g11796.a));
				#ifdef _ENABLESATURATION_ON
				float4 staticSwitch38_g11789 = appendResult8_g11796;
				#else
				float4 staticSwitch38_g11789 = staticSwitch28_g11789;
				#endif
				float4 temp_output_15_0_g11798 = staticSwitch38_g11789;
				float3 temp_output_82_0_g11798 = (_InnerOutlineColor).rgb;
				float2 temp_output_7_0_g11798 = temp_output_1_0_g11789;
				float temp_output_179_0_g11798 = temp_output_39_0_g11789;
				#ifdef _INNEROUTLINETEXTURETOGGLE_ON
				float3 staticSwitch187_g11798 = ( (tex2D( _InnerOutlineTintTexture, ( temp_output_7_0_g11798 + ( _InnerOutlineTextureSpeed * temp_output_179_0_g11798 ) ) )).rgb * temp_output_82_0_g11798 );
				#else
				float3 staticSwitch187_g11798 = temp_output_82_0_g11798;
				#endif
				float linValue16_g11800 = tex2D( _UberNoiseTexture, ( ( ( temp_output_179_0_g11798 * _InnerOutlineNoiseSpeed ) + temp_output_7_0_g11798 ) * _InnerOutlineNoiseScale ) ).r;
				...
				float2 staticSwitch169_g11798 = ( ( localMyCustomExpression16_g11800 - 0.5 ) * _InnerOutlineDistortionIntensity );
				#else
				float2 staticSwitch169_g11798 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g11798 = ( staticSwitch169_g11798 + temp_output_7_0_g11798 );
				float2 appendResult10_g11799 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 appendResult2_g11799 = (float2(1.0 , ( _MainTex_TexelSize.z / _MainTex_TexelSize.w )));
				#ifdef _RESIZABLETEXTURE_ON
				float2 staticSwitch9_g11799 = appendResult2_g11799;
				#else
				float2 staticSwitch9_g11799 = ( float2( 100,100 ) / appendResult10_g11799 );
				#endif
				float2 temp_output_25_0_g11798 = staticSwitch9_g11799;
				float temp_output_178_0_g11798 = ( _InnerOutlineFade * ( 1.0 - min( min( min( min( min( min( min( tex2D( _MainTex, ( temp_output_131_0_g11798 + ( ( _InnerOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g11798 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g11798 + ( ( _InnerOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g11798 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11798 + ( ( _InnerOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g11798 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11798 + ( ( _InnerOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g11798 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11798 + ( ( _InnerOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g11798 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11798 + ( ( _InnerOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g11798 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11798 + ( ( _InnerOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g11798 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11798 + ( ( _InnerOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g11798 ) ) ).a ) ) );
				float3 lerpResult176_g11798 = lerp( (temp_output_15_0_g11798).rgb , staticSwitch187_g11798 , temp_output_178_0_g11798);
				#ifdef _INNEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch188_g11798 = ( temp_output_178_0_g11798 * temp_output_15_0_g11798.a );
				#else
				float staticSwitch188_g11798 = temp_output_15_0_g11798.a;
				#endif
				float4 appendResult177_g11798 = (float4(lerpResult176_g11798 , staticSwitch188_g11798));
				#ifdef _ENABLEINNEROUTLINE_ON
				float4 staticSwitch12_g11789 = appendResult177_g11798;
				#else
				float4 staticSwitch12_g11789 = staticSwitch38_g11789;
				#endif
				float4 temp_output_15_0_g11826 = staticSwitch12_g11789;
				float3 temp_output_82_0_g11826 = (_OuterOutlineColor).rgb;
				float2 temp_output_7_0_g11826 = temp_output_1_0_g11789;
				float temp_output_186_0_g11826 = temp_output_39_0_g11789;
				#ifdef _OUTEROUTLINETEXTURETOGGLE_ON
				float3 staticSwitch199_g11826 = ( (tex2D( _OuterOutlineTintTexture, ( temp_output_7_0_g11826 + ( _OuterOutlineTextureSpeed * temp_output_186_0_g11826 ) ) )).rgb * temp_output_82_0_g11826 );
				#else
				float3 staticSwitch199_g11826 = temp_output_82_0_g11826;
				#endif
				float temp_output_182_0_g11826 = ( ( 1.0 - temp_output_15_0_g11826.a ) * min( ( _OuterOutlineFade * 3.0 ) , 1.0 ) );
				#ifdef _OUTEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch203_g11826 = 1.0;
				#else
				float staticSwitch203_g11826 = temp_output_182_0_g11826;
				#endif
				float3 lerpResult178_g11826 = lerp( (temp_output_15_0_g11826).rgb , staticSwitch199_g11826 , staticSwitch203_g11826);
				float3 lerpResult170_g11826 = lerp( lerpResult178_g11826 , staticSwitch199_g11826 , staticSwitch203_g11826);
				float linValue16_g11827 = tex2D( _UberNoiseTexture, ( ( ( temp_output_186_0_g11826 * _OuterOutlineNoiseSpeed ) + temp_output_7_0_g11826 ) * _OuterOutlineNoiseScale ) ).r;
				...
				float2 staticSwitch157_g11826 = ( ( localMyCustomExpression16_g11827 - 0.5 ) * _OuterOutlineDistortionIntensity );
				#else
				float2 staticSwitch157_g11826 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g11826 = ( staticSwitch157_g11826 + temp_output_7_0_g11826 );
				float2 appendResult10_g11828 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 appendResult2_g11828 = (float2(1.0 , ( _MainTex_TexelSize.z / _MainTex_TexelSize.w )));
				#ifdef _RESIZABLETEXTURE_ON
				float2 staticSwitch9_g11828 = appendResult2_g11828;
				#else
				float2 staticSwitch9_g11828 = ( float2( 100,100 ) / appendResult10_g11828 );
				#endif
				float2 temp_output_25_0_g11826 = staticSwitch9_g11828;
				float lerpResult168_g11826 = lerp( temp_output_15_0_g11826.a , min( ( max( max( max( max( max( max( max( tex2D( _MainTex, ( temp_output_131_0_g11826 + ( ( _OuterOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g11826 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g11826 + ( ( _OuterOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g11826 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11826 + ( ( _OuterOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g11826 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11826 + ( ( _OuterOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g11826 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11826 + ( ( _OuterOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g11826 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11826 + ( ( _OuterOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g11826 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11826 + ( ( _OuterOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g11826 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11826 + ( ( _OuterOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g11826 ) ) ).a ) * 3.0 ) , 1.0 ) , _OuterOutlineFade);
				#ifdef _OUTEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch200_g11826 = ( temp_output_182_0_g11826 * lerpResult168_g11826 );
				#else
				float staticSwitch200_g11826 = lerpResult168_g11826;
				#endif
				float4 appendResult174_g11826 = (float4(lerpResult170_g11826 , staticSwitch200_g11826));
				#ifdef _ENABLEOUTEROUTLINE_ON
				float4 staticSwitch13_g11789 = appendResult174_g11826;
				#else
				float4 staticSwitch13_g11789 = staticSwitch12_g11789;
				#endif
				float4 temp_output_15_0_g11803 = staticSwitch13_g11789;
				float3 temp_output_82_0_g11803 = (_PixelOutlineColor).rgb;
				float2 temp_output_7_0_g11803 = temp_output_1_0_g11789;
				#ifdef _PIXELOUTLINETEXTURETOGGLE_ON
				float3 staticSwitch199_g11803 = ( (tex2D( _PixelOutlineTintTexture, ( temp_output_7_0_g11803 + ( _PixelOutlineTextureSpeed * temp_output_39_0_g11789 ) ) )).rgb * temp_output_82_0_g11803 );
				#else
				float3 staticSwitch199_g11803 = temp_output_82_0_g11803;
				#endif
				float temp_output_213_0_g11803 = ( _PixelOutlineFade * step( temp_output_15_0_g11803.a , _PixelOutlineAlphaLimit ) );
				float temp_output_182_0_g11803 = ( ( 1.0 - temp_output_15_0_g11803.a ) * min( ( temp_output_213_0_g11803 * 3.0 ) , 1.0 ) );
				#ifdef _PIXELOUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch203_g11803 = 1.0;
				#else
				float staticSwitch203_g11803 = temp_output_182_0_g11803;
				#endif
				float3 lerpResult178_g11803 = lerp( (temp_output_15_0_g11803).rgb , staticSwitch199_g11803 , staticSwitch203_g11803);
				float3 lerpResult170_g11803 = lerp( lerpResult178_g11803 , staticSwitch199_g11803 , staticSwitch203_g11803);
				float2 appendResult206_g11803 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_209_0_g11803 = ( float2( 1,1 ) / appendResult206_g11803 );
				float lerpResult168_g11803 = lerp( temp_output_15_0_g11803.a , min( ( max( max( max( tex2D( _MainTex, ( temp_output_7_0_g11803 + ( ( _PixelOutlineWidth * float2( 0,-1 ) ) * temp_output_209_0_g11803 ) ) ).a , tex2D( _MainTex, ( temp_output_7_0_g11803 + ( ( _PixelOutlineWidth * float2( 0,1 ) ) * temp_output_209_0_g11803 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g11803 + ( ( _PixelOutlineWidth * float2( -1,0 ) ) * temp_output_209_0_g11803 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g11803 + ( ( _PixelOutlineWidth * float2( 1,0 ) ) * temp_output_209_0_g11803 ) ) ).a ) * 3.0 ) , 1.0 ) , temp_output_213_0_g11803);
				#ifdef _PIXELOUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch200_g11803 = ( temp_output_182_0_g11803 * lerpResult168_g11803 );
				#else
				float staticSwitch200_g11803 = lerpResult168_g11803;
				#endif
				float4 appendResult174_g11803 = (float4(lerpResult170_g11803 , staticSwitch200_g11803));
				#ifdef _ENABLEPIXELOUTLINE_ON
				float4 staticSwitch48_g11789 = appendResult174_g11803;
				#else
				float4 staticSwitch48_g11789 = staticSwitch13_g11789;
				#endif
				float3 lerpResult15_g11790 = lerp( (_PingPongGlowFrom).rgb , (_PingPongGlowTo).rgb , ( ( sin( ( temp_output_39_0_g11789 * _PingPongGlowFrequency ) ) + 1.0 ) / 2.0 ));
				float4 temp_output_5_0_g11790 = staticSwitch48_g11789;
				float4 break2_g11791 = temp_output_5_0_g11790;
				float4 appendResult12_g11790 = (float4(( ( lerpResult15_g11790 * _PingPongGlowFade * pow( max( ( ( break2_g11791.x + break2_g11791.x + break2_g11791.y + break2_g11791.y + break2_g11791.y + break2_g11791.z ) / 6.0 ) , 0.0001 ) , max( _PingPongGlowContrast , 0.0001 ) ) ) + (temp_output_5_0_g11790).rgb ) , temp_output_5_0_g11790.a));
				#ifdef _ENABLEPINGPONGGLOW_ON
				float4 staticSwitch46_g11789 = appendResult12_g11790;
				#else
				float4 staticSwitch46_g11789 = staticSwitch48_g11789;
				#endif
				float4 temp_output_361_0 = staticSwitch46_g11789;
				float4 temp_output_1_0_g11831 = temp_output_361_0;
				float4 break2_g11832 = temp_output_1_0_g11831;
				float temp_output_44_0_g11831 = unity_OrthoParams.y;
				float4 appendResult22_g11831 = (float4(( (_HologramTint).rgb * pow( max( ( ( break2_g11832.x + break2_g11832.x + break2_g11832.y + break2_g11832.y + break2_g11832.y + break2_g11832.z ) / 6.0 ) , 0.0001 ) , max( _HologramContrast , 0.0001 ) ) ) , ( max( pow( abs( sin( ( ( ( ( shaderTime237 * ( _HologramLineSpeed * temp_output_44_0_g11831 * 0.2 ) ) + ase_positionWS.y ) / temp_output_44_0_g11831 ) * _HologramLineFrequency ) ) ) , _HologramLineGap ) , _HologramMinAlpha ) * temp_output_1_0_g11831.a )));
				float4 lerpResult37_g11831 = lerp( temp_output_1_0_g11831 , appendResult22_g11831 , hologramFade182);
				#ifdef _ENABLEHOLOGRAM_ON
				float4 staticSwitch56 = lerpResult37_g11831;
				#else
				float4 staticSwitch56 = temp_output_361_0;
				#endif
				float4 temp_output_1_0_g11834 = staticSwitch56;
				float4 break2_g11836 = temp_output_1_0_g11834;
				float temp_output_34_0_g11834 = shaderTime237;
				float linValue16_g11835 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchNoiseSpeed * temp_output_34_0_g11834 ) ) * _GlitchNoiseScale ) ).r;
				float localMyCustomExpression16_g11835 = MyCustomExpression16_g11835( linValue16_g11835 );
				float3 hsvTorgb3_g11837 = HSVToRGB( float3(( localMyCustomExpression16_g11835 + ( temp_output_34_0_g11834 * _GlitchHueSpeed ) ),1.0,1.0) );
				float3 lerpResult23_g11834 = lerp( (temp_output_1_0_g11834).rgb , ( ( ( break2_g11836.x + break2_g11836.x + break2_g11836.y + break2_g11836.y + break2_g11836.y + break2_g11836.z ) / 6.0 ) * _GlitchBrightness * hsvTorgb3_g11837 ) , glitchFade152);
				float4 appendResult27_g11834 = (float4(lerpResult23_g11834 , temp_output_1_0_g11834.a));
				#ifdef _ENABLEGLITCH_ON
				float4 staticSwitch57 = appendResult27_g11834;
				#else
				float4 staticSwitch57 = staticSwitch56;
				#endif
				float4 temp_output_3_0_g11839 = staticSwitch57;
				float4 temp_output_1_0_g11869 = temp_output_3_0_g11839;
				float2 temp_output_41_0_g11839 = shaderPosition235;
				float2 temp_output_99_0_g11869 = temp_output_41_0_g11839;
				float temp_output_40_0_g11839 = shaderTime237;
				float linValue16_g11874 = tex2D( _UberNoiseTexture, ( ( ( temp_output_40_0_g11839 * _CamouflageDistortionSpeed ) + temp_output_99_0_g11869 ) * _CamouflageDistortionScale ) ).r;
				float localMyCustomExpression16_g11874 = MyCustomExpression16_g11874( linValue16_g11874 );
				#ifdef _CAMOUFLAGEANIMATIONTOGGLE_ON
				float2 staticSwitch101_g11869 = ( ( ( localMyCustomExpression16_g11874 - 0.25 ) * _CamouflageDistortionIntensity ) + temp_output_99_0_g11869 );
				#else
				float2 staticSwitch101_g11869 = temp_output_99_0_g11869;
				#endif
				float linValue16_g11871 = tex2D( _UberNoiseTexture, ( staticSwitch101_g11869 * _CamouflageNoiseScaleA ) ).r;
				float localMyCustomExpression16_g11871 = MyCustomExpression16_g11871( linValue16_g11871 );
				float clampResult52_g11869 = clamp( ( ( _CamouflageDensityA - localMyCustomExpression16_g11871 ) / max( _CamouflageSmoothnessA , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult55_g11869 = lerp( _CamouflageBaseColor , ( _CamouflageColorA * clampResult52_g11869 ) , clampResult52_g11869);
				float linValue16_g11873 = tex2D( _UberNoiseTexture, ( ( staticSwitch101_g11869 + float2( 12.3,12.3 ) ) * _CamouflageNoiseScaleB ) ).r;
				float localMyCustomExpression16_g11873 = MyCustomExpression16_g11873( linValue16_g11873 );
				float clampResult65_g11869 = clamp( ( ( _CamouflageDensityB - localMyCustomExpression16_g11873 ) / max( _CamouflageSmoothnessB , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult68_g11869 = lerp( lerpResult55_g11869 , ( _CamouflageColorB * clampResult65_g11869 ) , clampResult65_g11869);
				float4 break2_g11872 = temp_output_1_0_g11869;
				float3 lerpResult4_g11869 = lerp( (temp_output_1_0_g11869).rgb , ( (lerpResult68_g11869).rgb * pow( max( ( ( break2_g11872.x + break2_g11872.x + break2_g11872.y + break2_g11872.y + break2_g11872.y + break2_g11872.z ) / 6.0 ) , 0.0001 ) , max( _CamouflageContrast , 0.0001 ) ) ) , _CamouflageFade);
				float4 appendResult7_g11869 = (float4(lerpResult4_g11869 , temp_output_1_0_g11869.a));
				#ifdef _ENABLECAMOUFLAGE_ON
				float4 staticSwitch26_g11839 = appendResult7_g11869;
				#else
				float4 staticSwitch26_g11839 = temp_output_3_0_g11839;
				#endif
				float4 temp_output_1_0_g11862 = staticSwitch26_g11839;
				float temp_output_59_0_g11862 = temp_output_40_0_g11839;
				float2 temp_output_58_0_g11862 = temp_output_41_0_g11839;
				float linValue16_g11863 = tex2D( _UberNoiseTexture, ( ( ( temp_output_59_0_g11862 * _MetalNoiseDistortionSpeed ) + temp_output_58_0_g11862 ) * _MetalNoiseDistortionScale ) ).r;
				float localMyCustomExpression16_g11863 = MyCustomExpression16_g11863( linValue16_g11863 );
				float linValue16_g11865 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11863 - 0.25 ) * _MetalNoiseDistortion ) + ( ( temp_output_59_0_g11862 * _MetalNoiseSpeed ) + temp_output_58_0_g11862 ) ) * _MetalNoiseScale ) ).r;
				...
				float temp_output_5_0_g11862 = ( ( break2_g11864.x + break2_g11864.x + break2_g11864.y + break2_g11864.y + break2_g11864.y + break2_g11864.z ) / 6.0 );
				float2 uv_MetalMask = IN.texcoord.xy * _MetalMask_ST.xy + _MetalMask_ST.zw;
				float4 tex2DNode3_g11867 = tex2D( _MetalMask, uv_MetalMask );
				#ifdef _METALMASKTOGGLE_ON
				float staticSwitch60_g11862 = ( _MetalFade * ( tex2DNode3_g11867.r * tex2DNode3_g11867.a ) );
				#else
				float staticSwitch60_g11862 = _MetalFade;
				#endif
				float4 lerpResult45_g11862 = lerp( temp_output_1_0_g11862 , ( ( max( ( ( _MetalHighlightDensity - localMyCustomExpression16_g11865 ) / max( _MetalHighlightDensity , 0.01 ) ) , 0.0 ) * _MetalHighlightColor * pow( max( temp_output_5_0_g11862 , 0.0001 ) , max( _MetalHighlightContrast , 0.0001 ) ) ) + ( pow( max( temp_output_5_0_g11862 , 0.0001 ) , max( _MetalContrast , 0.0001 ) ) * _MetalColor ) ) , staticSwitch60_g11862);
				float4 appendResult8_g11862 = (float4((lerpResult45_g11862).rgb , (temp_output_1_0_g11862).a));
				#ifdef _ENABLEMETAL_ON
				float4 staticSwitch28_g11839 = appendResult8_g11862;
				#else
				float4 staticSwitch28_g11839 = staticSwitch26_g11839;
				#endif
				float4 temp_output_1_0_g11854 = staticSwitch28_g11839;
				float4 break2_g11855 = temp_output_1_0_g11854;
				float temp_output_7_0_g11854 = ( ( break2_g11855.x + break2_g11855.x + break2_g11855.y + break2_g11855.y + break2_g11855.y + break2_g11855.z ) / 6.0 );
				float2 temp_output_72_0_g11854 = temp_output_41_0_g11839;
				float linValue16_g11856 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11854 * _FrozenSnowScale ) ).r;
				float localMyCustomExpression16_g11856 = MyCustomExpression16_g11856( linValue16_g11856 );
				float temp_output_73_0_g11854 = temp_output_40_0_g11839;
				float linValue16_g11858 = tex2D( _UberNoiseTexture, ( ( ( temp_output_73_0_g11854 * _FrozenHighlightDistortionSpeed ) + temp_output_72_0_g11854 ) * _FrozenHighlightDistortionScale ) ).r;
				float localMyCustomExpression16_g11858 = MyCustomExpression16_g11858( linValue16_g11858 );
				float linValue16_g11859 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11858 - 0.25 ) * _FrozenHighlightDistortion ) + ( ( temp_output_73_0_g11854 * _FrozenHighlightSpeed ) + temp_output_72_0_g11854 ) ) * _FrozenHighlightScale ) ).r;
				float localMyCustomExpression16_g11859 = MyCustomExpression16_g11859( linValue16_g11859 );
				float3 lerpResult57_g11854 = lerp( (temp_output_1_0_g11854).rgb , ( ( pow( max( temp_output_7_0_g11854 , 0.0001 ) , max( _FrozenContrast , 0.0001 ) ) * (_FrozenTint).rgb ) + ( pow( max( temp_output_7_0_g11854 , 0.0001 ) , max( _FrozenSnowContrast , 0.0001 ) ) * ( (_FrozenSnowColor).rgb * max( ( _FrozenSnowDensity - localMyCustomExpression16_g11856 ) , 0.0 ) ) ) + (( max( ( ( _FrozenHighlightDensity - localMyCustomExpression16_g11859 ) / max( _FrozenHighlightDensity , 0.01 ) ) , 0.0 ) * _FrozenHighlightColor * pow( max( temp_output_7_0_g11854 , 0.0001 ) , max( _FrozenHighlightContrast , 0.0001 ) ) )).rgb ) , _FrozenFade);
				float4 appendResult26_g11854 = (float4(lerpResult57_g11854 , temp_output_1_0_g11854.a));
				#ifdef _ENABLEFROZEN_ON
				float4 staticSwitch29_g11839 = appendResult26_g11854;
				#else
				float4 staticSwitch29_g11839 = staticSwitch28_g11839;
				#endif
				float4 temp_output_1_0_g11848 = staticSwitch29_g11839;
				float3 temp_output_28_0_g11848 = (temp_output_1_0_g11848).rgb;
				float4 break2_g11852 = float4( temp_output_28_0_g11848 , 0.0 );
				float2 temp_output_72_0_g11848 = temp_output_41_0_g11839;
				float linValue16_g11851 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11848 * _BurnSwirlNoiseScale ) ).r;
				float localMyCustomExpression16_g11851 = MyCustomExpression16_g11851( linValue16_g11851 );
				float linValue16_g11849 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11851 - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_72_0_g11848 ) * _BurnInsideNoiseScale ) ).r;
				float localMyCustomExpression16_g11849 = MyCustomExpression16_g11849( linValue16_g11849 );
				float clampResult68_g11848 = clamp( ( _BurnInsideNoiseFactor - localMyCustomExpression16_g11849 ) , 0.0 , 1.0 );
				float linValue16_g11850 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11848 * _BurnEdgeNoiseScale ) ).r;
				float localMyCustomExpression16_g11850 = MyCustomExpression16_g11850( linValue16_g11850 );
				float temp_output_15_0_g11848 = ( ( ( _BurnRadius - distance( temp_output_72_0_g11848 , _BurnPosition ) ) + ( localMyCustomExpression16_g11850 * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
				float clampResult18_g11848 = clamp( temp_output_15_0_g11848 , 0.0 , 1.0 );
				float3 lerpResult29_g11848 = lerp( temp_output_28_0_g11848 , ( pow( max( ( ( break2_g11852.x + break2_g11852.x + break2_g11852.y + break2_g11852.y + break2_g11852.y + break2_g11852.z ) / 6.0 ) , 0.0001 ) , max( _BurnInsideContrast , 0.0001 ) ) * ( ( (_BurnInsideNoiseColor).rgb * clampResult68_g11848 ) + (_BurnInsideColor).rgb ) ) , clampResult18_g11848);
				float3 lerpResult40_g11848 = lerp( temp_output_28_0_g11848 , ( lerpResult29_g11848 + ( ( step( temp_output_15_0_g11848 , 1.0 ) * step( 0.0 , temp_output_15_0_g11848 ) ) * (_BurnEdgeColor).rgb ) ) , _BurnFade);
				float4 appendResult43_g11848 = (float4(lerpResult40_g11848 , temp_output_1_0_g11848.a));
				#ifdef _ENABLEBURN_ON
				float4 staticSwitch32_g11839 = appendResult43_g11848;
				#else
				float4 staticSwitch32_g11839 = staticSwitch29_g11839;
				#endif
				float2 temp_output_42_0_g11844 = temp_output_41_0_g11839;
				float linValue16_g11845 = tex2D( _UberNoiseTexture, ( temp_output_42_0_g11844 * _RainbowNoiseScale ) ).r;
				float localMyCustomExpression16_g11845 = MyCustomExpression16_g11845( linValue16_g11845 );
				float3 hsvTorgb3_g11847 = HSVToRGB( float3(( ( ( distance( temp_output_42_0_g11844 , _RainbowCenter ) + ( localMyCustomExpression16_g11845 * _RainbowNoiseFactor ) ) * _RainbowDensity ) + ( _RainbowSpeed * temp_output_40_0_g11839 ) ),1.0,1.0) );
				float3 hsvTorgb36_g11844 = RGBToHSV( hsvTorgb3_g11847 );
				float3 hsvTorgb37_g11844 = HSVToRGB( float3(hsvTorgb36_g11844.x,_RainbowSaturation,( hsvTorgb36_g11844.z * _RainbowBrightness )) );
				float4 temp_output_1_0_g11844 = staticSwitch32_g11839;
				float4 break2_g11846 = temp_output_1_0_g11844;
				float saferPower24_g11844 = abs( ( ( break2_g11846.x + break2_g11846.x + break2_g11846.y + break2_g11846.y + break2_g11846.y + break2_g11846.z ) / 6.0 ) );
				float4 appendResult29_g11844 = (float4(( ( hsvTorgb37_g11844 * pow( saferPower24_g11844 , max( _RainbowContrast , 0.001 ) ) * _RainbowFade ) + (temp_output_1_0_g11844).rgb ) , temp_output_1_0_g11844.a));
				#ifdef _ENABLERAINBOW_ON
				float4 staticSwitch34_g11839 = appendResult29_g11844;
				#else
				float4 staticSwitch34_g11839 = staticSwitch32_g11839;
				#endif
				float4 temp_output_1_0_g11840 = staticSwitch34_g11839;
				float3 temp_output_57_0_g11840 = (temp_output_1_0_g11840).rgb;
				float4 break2_g11842 = temp_output_1_0_g11840;
				float3 temp_cast_69 = (( ( break2_g11842.x + break2_g11842.x + break2_g11842.y + break2_g11842.y + break2_g11842.y + break2_g11842.z ) / 6.0 )).xxx;
				float3 lerpResult92_g11840 = lerp( temp_cast_69 , temp_output_57_0_g11840 , _ShineSaturation);
				float3 temp_cast_70 = (max( max( _ShineContrast , 0.001 ) , 0.0001 )).xxx;
				float3 rotatedValue69_g11840 = RotateAroundAxis( float3( 0,0,0 ), float3( ( _ShineFrequency * temp_output_41_0_g11839 ) ,  0.0 ), float3( 0,0,1 ), ( ( _ShineRotation / 180.0 ) * UNITY_PI ) );
				float temp_output_103_0_g11840 = ( _ShineFrequency * _ShineWidth );
				float clampResult80_g11840 = clamp( ( ( ( sin( ( rotatedValue69_g11840.x - ( temp_output_40_0_g11839 * _ShineSpeed * _ShineFrequency ) ) ) - ( 1.0 - temp_output_103_0_g11840 ) ) / temp_output_103_0_g11840 ) * _ShineSmooth ) , 0.0 , 1.0 );
				float2 uv_ShineMask = IN.texcoord.xy * _ShineMask_ST.xy + _ShineMask_ST.zw;
				float4 tex2DNode3_g11841 = tex2D( _ShineMask, uv_ShineMask );
				#ifdef _SHINEMASKTOGGLE_ON
				float staticSwitch98_g11840 = ( _ShineFade * ( tex2DNode3_g11841.r * tex2DNode3_g11841.a ) );
				#else
				float staticSwitch98_g11840 = _ShineFade;
				#endif
				float4 appendResult8_g11840 = (float4(( temp_output_57_0_g11840 + ( ( pow( max( lerpResult92_g11840 , float3( 0.0001,0.0001,0.0001 ) ) , temp_cast_70 ) * (_ShineColor).rgb ) * clampResult80_g11840 * staticSwitch98_g11840 ) ) , (temp_output_1_0_g11840).a));
				#ifdef _ENABLESHINE_ON
				float4 staticSwitch36_g11839 = appendResult8_g11840;
				#else
				float4 staticSwitch36_g11839 = staticSwitch34_g11839;
				#endif
				float temp_output_41_0_g11875 = temp_output_40_0_g11839;
				float linValue16_g11877 = tex2D( _UberNoiseTexture, ( ( ( temp_output_41_0_g11875 * _PoisonNoiseSpeed ) + temp_output_41_0_g11839 ) * _PoisonNoiseScale ) ).r;
				float localMyCustomExpression16_g11877 = MyCustomExpression16_g11877( linValue16_g11877 );
				float3 temp_output_24_0_g11875 = (_PoisonColor).rgb;
				float4 temp_output_1_0_g11875 = staticSwitch36_g11839;
				float3 temp_output_28_0_g11875 = (temp_output_1_0_g11875).rgb;
				float4 break2_g11876 = float4( temp_output_28_0_g11875 , 0.0 );
				float3 lerpResult32_g11875 = lerp( temp_output_28_0_g11875 , ( temp_output_24_0_g11875 * ( ( break2_g11876.x + break2_g11876.x + break2_g11876.y + break2_g11876.y + break2_g11876.y + break2_g11876.z ) / 6.0 ) ) , ( _PoisonFade * _PoisonRecolorFactor ));
				float4 appendResult27_g11875 = (float4(( ( max( pow( max( abs( ( ( ( localMyCustomExpression16_g11877 + ( temp_output_41_0_g11875 * _PoisonShiftSpeed ) ) % 1.0 ) + -0.5 ) ) , 0.0001 ) , max( _PoisonDensity , 0.0001 ) ) , 0.0 ) * temp_output_24_0_g11875 * _PoisonFade * _PoisonNoiseBrightness ) + lerpResult32_g11875 ) , temp_output_1_0_g11875.a));
				#ifdef _ENABLEPOISON_ON
				float4 staticSwitch39_g11839 = appendResult27_g11875;
				#else
				float4 staticSwitch39_g11839 = staticSwitch36_g11839;
				#endif
				float4 temp_output_10_0_g11879 = staticSwitch39_g11839;
				float3 temp_output_12_0_g11879 = (temp_output_10_0_g11879).rgb;
				float2 temp_output_2_0_g11879 = temp_output_41_0_g11839;
				float temp_output_1_0_g11879 = temp_output_40_0_g11839;
				float2 temp_output_6_0_g11879 = ( temp_output_1_0_g11879 * _EnchantedSpeed );
				float linValue16_g11882 = tex2D( _UberNoiseTexture, ( ( ( temp_output_2_0_g11879 - ( ( temp_output_6_0_g11879 + float2( 1.234,5.6789 ) ) * float2( 0.95,1.05 ) ) ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g11882 = MyCustomExpression16_g11882( linValue16_g11882 );
				float linValue16_g11880 = tex2D( _UberNoiseTexture, ( ( ( temp_output_6_0_g11879 + temp_output_2_0_g11879 ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g11880 = MyCustomExpression16_g11880( linValue16_g11880 );
				float temp_output_36_0_g11879 = ( localMyCustomExpression16_g11882 + localMyCustomExpression16_g11880 );
				float temp_output_43_0_g11879 = ( temp_output_36_0_g11879 * 0.5 );
				float3 lerpResult42_g11879 = lerp( (_EnchantedLowColor).rgb , (_EnchantedHighColor).rgb , temp_output_43_0_g11879);
				float3 hsvTorgb53_g11879 = HSVToRGB( float3(( ( temp_output_43_0_g11879 * _EnchantedRainbowDensity ) + ( _EnchantedRainbowSpeed * temp_output_1_0_g11879 ) ),_EnchantedRainbowSaturation,1.0) );
				#ifdef _ENCHANTEDRAINBOWTOGGLE_ON
				float3 staticSwitch50_g11879 = hsvTorgb53_g11879;
				#else
				float3 staticSwitch50_g11879 = lerpResult42_g11879;
				#endif
				float4 break2_g11881 = temp_output_10_0_g11879;
				float3 temp_output_40_0_g11879 = ( staticSwitch50_g11879 * pow( max( ( ( break2_g11881.x + break2_g11881.x + break2_g11881.y + break2_g11881.y + break2_g11881.y + break2_g11881.z ) / 6.0 ) , 0.0001 ) , max( _EnchantedContrast , 0.0001 ) ) * _EnchantedBrightness );
				float temp_output_45_0_g11879 = ( max( ( temp_output_36_0_g11879 - _EnchantedReduce ) , 0.0 ) * _EnchantedFade );
				float3 lerpResult44_g11879 = lerp( temp_output_12_0_g11879 , temp_output_40_0_g11879 , temp_output_45_0_g11879);
				#ifdef _ENCHANTEDLERPTOGGLE_ON
				float3 staticSwitch47_g11879 = lerpResult44_g11879;
				#else
				float3 staticSwitch47_g11879 = ( temp_output_12_0_g11879 + ( temp_output_40_0_g11879 * temp_output_45_0_g11879 ) );
				#endif
				float4 appendResult19_g11879 = (float4(staticSwitch47_g11879 , temp_output_10_0_g11879.a));
				#ifdef _ENABLEENCHANTED_ON
				float4 staticSwitch11_g11879 = appendResult19_g11879;
				#else
				float4 staticSwitch11_g11879 = temp_output_10_0_g11879;
				#endif
				float4 temp_output_1_0_g11884 = staticSwitch11_g11879;
				float4 break5_g11884 = temp_output_1_0_g11884;
				float3 appendResult32_g11884 = (float3(break5_g11884.r , break5_g11884.g , break5_g11884.b));
				float4 break2_g11885 = temp_output_1_0_g11884;
				float temp_output_4_0_g11884 = ( ( break2_g11885.x + break2_g11885.x + break2_g11885.y + break2_g11885.y + break2_g11885.y + break2_g11885.z ) / 6.0 );
				float temp_output_11_0_g11884 = ( ( ( temp_output_4_0_g11884 + ( temp_output_40_0_g11839 * _ShiftingSpeed ) ) * _ShiftingDensity ) % 1.0 );
				float3 lerpResult20_g11884 = lerp( (_ShiftingColorA).rgb , (_ShiftingColorB).rgb , ( abs( ( temp_output_11_0_g11884 - 0.5 ) ) * 2.0 ));
				float3 hsvTorgb12_g11884 = HSVToRGB( float3(temp_output_11_0_g11884,_ShiftingSaturation,_ShiftingBrightness) );
				#ifdef _SHIFTINGRAINBOWTOGGLE_ON
				float3 staticSwitch26_g11884 = hsvTorgb12_g11884;
				#else
				float3 staticSwitch26_g11884 = ( lerpResult20_g11884 * _ShiftingBrightness );
				#endif
				float3 lerpResult31_g11884 = lerp( appendResult32_g11884 , ( staticSwitch26_g11884 * pow( max( temp_output_4_0_g11884 , 0.0001 ) , max( _ShiftingContrast , 0.0001 ) ) ) , _ShiftingFade);
				float4 appendResult6_g11884 = (float4(lerpResult31_g11884 , break5_g11884.a));
				#ifdef _ENABLESHIFTING_ON
				float4 staticSwitch33_g11884 = appendResult6_g11884;
				#else
				float4 staticSwitch33_g11884 = temp_output_1_0_g11884;
				#endif
				float4 temp_output_5_0_g11891 = staticSwitch33_g11884;
				float4 break6_g11891 = temp_output_5_0_g11891;
				float3 appendResult11_g11891 = (float3(break6_g11891.r , break6_g11891.g , break6_g11891.b));
				float temp_output_27_0_g11891 = temp_output_40_0_g11839;
				#ifdef _TEXTURELAYER1SCROLLTOGGLE_ON
				float2 staticSwitch73_g11891 = ( _TextureLayer1Offset + ( _TextureLayer1ScrollSpeed * temp_output_27_0_g11891 ) );
				#else
				float2 staticSwitch73_g11891 = _TextureLayer1Offset;
				#endif
				float2 temp_output_72_0_g11891 = ( ( _TextureLayer1Scale * temp_output_41_0_g11839 ) - staticSwitch73_g11891 );
				float2 temp_cast_79 = (_TextureLayer1EdgeClip).xx;
				float2 UV10_g11892 = ( ( ( ( ( ( ( ( ( temp_output_72_0_g11891 % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) ) - float2( 0.5,0.5 ) ) * ( float2( 1,1 ) - temp_cast_79 ) ) + float2( 0.5,0.5 ) ) % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) );
				int Width10_g11892 = _TextureLayer1Columns;
				int Height10_g11892 = _TextureLayer1Rows;
				float Tile10_g11892 = round( ( ( _TextureLayer1Speed * temp_output_27_0_g11891 ) + _TextureLayer1StartFrame ) );
				float2 Invert10_g11892 = float2( 0,1 );
				float2 localMyCustomExpression10_g11892 = MyCustomExpression10_g11892( UV10_g11892 , Width10_g11892 , Height10_g11892 , Tile10_g11892 , Invert10_g11892 );
				#ifdef _TEXTURELAYER1SHEETTOGGLE_ON
				float2 staticSwitch20_g11891 = localMyCustomExpression10_g11892;
				#else
				float2 staticSwitch20_g11891 = temp_output_72_0_g11891;
				#endif
				float4 tex2DNode3_g11891 = tex2D( _TextureLayer1Texture, staticSwitch20_g11891 );
				float3 appendResult13_g11891 = (float3(tex2DNode3_g11891.r , tex2DNode3_g11891.g , tex2DNode3_g11891.b));
				float3 appendResult18_g11891 = (float3(_TextureLayer1Color.r , _TextureLayer1Color.g , _TextureLayer1Color.b));
				float3 temp_output_16_0_g11891 = ( appendResult13_g11891 * appendResult18_g11891 );
				float4 break2_g11893 = temp_output_5_0_g11891;
				#ifdef _TEXTURELAYER1CONTRASTTOGGLE_ON
				float3 staticSwitch80_g11891 = ( pow( max( ( ( break2_g11893.x + break2_g11893.x + break2_g11893.y + break2_g11893.y + break2_g11893.y + break2_g11893.z ) / 6.0 ) , 0.0001 ) , max( _TextureLayer1Contrast , 0.0001 ) ) * temp_output_16_0_g11891 );
				#else
				float3 staticSwitch80_g11891 = temp_output_16_0_g11891;
				#endif
				float3 lerpResult12_g11891 = lerp( appendResult11_g11891 , staticSwitch80_g11891 , ( tex2DNode3_g11891.a * _TextureLayer1Fade ));
				float4 appendResult14_g11891 = (float4(lerpResult12_g11891 , break6_g11891.a));
				#ifdef _ENABLETEXTURELAYER1_ON
				float4 staticSwitch15_g11891 = appendResult14_g11891;
				#else
				float4 staticSwitch15_g11891 = temp_output_5_0_g11891;
				#endif
				float4 temp_output_5_0_g11887 = staticSwitch15_g11891;
				float4 break6_g11887 = temp_output_5_0_g11887;
				float3 appendResult11_g11887 = (float3(break6_g11887.r , break6_g11887.g , break6_g11887.b));
				float temp_output_27_0_g11887 = temp_output_40_0_g11839;
				#ifdef _TEXTURELAYER2SCROLLTOGGLE_ON
				float2 staticSwitch73_g11887 = ( _TextureLayer2Offset + ( _TextureLayer2ScrollSpeed * temp_output_27_0_g11887 ) );
				#else
				float2 staticSwitch73_g11887 = _TextureLayer2Offset;
				#endif
				float2 temp_output_72_0_g11887 = ( ( _TextureLayer2Scale * temp_output_41_0_g11839 ) - staticSwitch73_g11887 );
				float2 temp_cast_82 = (_TextureLayer2EdgeClip).xx;
				float2 UV10_g11888 = ( ( ( ( ( ( ( ( ( temp_output_72_0_g11887 % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) ) - float2( 0.5,0.5 ) ) * ( float2( 1,1 ) - temp_cast_82 ) ) + float2( 0.5,0.5 ) ) % float2( 1,1 ) ) + float2( 1,1 ) ) % float2( 1,1 ) );
				int Width10_g11888 = _TextureLayer2Columns;
				int Height10_g11888 = _TextureLayer2Rows;
				float Tile10_g11888 = round( ( ( _TextureLayer2Speed * temp_output_27_0_g11887 ) + _TextureLayer2StartFrame ) );
				float2 Invert10_g11888 = float2( 0,1 );
				float2 localMyCustomExpression10_g11888 = MyCustomExpression10_g11888( UV10_g11888 , Width10_g11888 , Height10_g11888 , Tile10_g11888 , Invert10_g11888 );
				#ifdef _TEXTURELAYER2SHEETTOGGLE_ON
				float2 staticSwitch20_g11887 = localMyCustomExpression10_g11888;
				#else
				float2 staticSwitch20_g11887 = temp_output_72_0_g11887;
				#endif
				float4 tex2DNode3_g11887 = tex2D( _TextureLayer2Texture, staticSwitch20_g11887 );
				float3 appendResult13_g11887 = (float3(tex2DNode3_g11887.r , tex2DNode3_g11887.g , tex2DNode3_g11887.b));
				float3 appendResult18_g11887 = (float3(_TextureLayer2Color.r , _TextureLayer2Color.g , _TextureLayer2Color.b));
				float3 temp_output_16_0_g11887 = ( appendResult13_g11887 * appendResult18_g11887 );
				float4 break2_g11889 = temp_output_5_0_g11887;
				#ifdef _TEXTURELAYER2CONTRASTTOGGLE_ON
				float3 staticSwitch84_g11887 = ( pow( max( ( ( break2_g11889.x + break2_g11889.x + break2_g11889.y + break2_g11889.y + break2_g11889.y + break2_g11889.z ) / 6.0 ) , 0.0001 ) , max( _TextureLayer2Contrast , 0.0001 ) ) * temp_output_16_0_g11887 );
				#else
				float3 staticSwitch84_g11887 = temp_output_16_0_g11887;
				#endif
				float3 lerpResult12_g11887 = lerp( appendResult11_g11887 , staticSwitch84_g11887 , ( tex2DNode3_g11887.a * _TextureLayer2Fade ));
				float4 appendResult14_g11887 = (float4(lerpResult12_g11887 , break6_g11887.a));
				#ifdef _ENABLETEXTURELAYER2_ON
				float4 staticSwitch15_g11887 = appendResult14_g11887;
				#else
				float4 staticSwitch15_g11887 = temp_output_5_0_g11887;
				#endif
				float4 temp_output_473_0 = staticSwitch15_g11887;
				float4 break4_g11895 = temp_output_473_0;
				float fullDistortionAlpha164 = _FullDistortionFade;
				float4 appendResult5_g11895 = (float4(break4_g11895.r , break4_g11895.g , break4_g11895.b , ( break4_g11895.a * fullDistortionAlpha164 )));
				#ifdef _ENABLEFULLDISTORTION_ON
				float4 staticSwitch77 = appendResult5_g11895;
				#else
				float4 staticSwitch77 = temp_output_473_0;
				#endif
				float4 break4_g11896 = staticSwitch77;
				float directionalDistortionAlpha167 = (( _DirectionalDistortionInvert )?( ( 1.0 - clampResult154_g11668 ) ):( clampResult154_g11668 ));
				float4 appendResult5_g11896 = (float4(break4_g11896.r , break4_g11896.g , break4_g11896.b , ( break4_g11896.a * directionalDistortionAlpha167 )));
				#ifdef _ENABLEDIRECTIONALDISTORTION_ON
				float4 staticSwitch75 = appendResult5_g11896;
				#else
				float4 staticSwitch75 = staticSwitch77;
				#endif
				float4 temp_output_1_0_g11897 = staticSwitch75;
				float4 temp_output_1_0_g11898 = temp_output_1_0_g11897;
				float temp_output_53_0_g11898 = max( _FullAlphaDissolveWidth , 0.001 );
				float2 temp_output_18_0_g11897 = shaderPosition235;
				float linValue16_g11899 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g11897 * _FullAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11899 = MyCustomExpression16_g11899( linValue16_g11899 );
				float clampResult17_g11898 = clamp( ( ( ( _FullAlphaDissolveFade * ( 1.0 + temp_output_53_0_g11898 ) ) - localMyCustomExpression16_g11899 ) / temp_output_53_0_g11898 ) , 0.0 , 1.0 );
				float4 appendResult3_g11898 = (float4((temp_output_1_0_g11898).rgb , ( temp_output_1_0_g11898.a * clampResult17_g11898 )));
				#ifdef _ENABLEFULLALPHADISSOLVE_ON
				float4 staticSwitch3_g11897 = appendResult3_g11898;
				#else
				float4 staticSwitch3_g11897 = temp_output_1_0_g11897;
				#endif
				float linValue16_g11907 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g11897 * _FullGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11907 = MyCustomExpression16_g11907( linValue16_g11907 );
				float temp_output_5_0_g11906 = localMyCustomExpression16_g11907;
				float temp_output_61_0_g11906 = step( temp_output_5_0_g11906 , _FullGlowDissolveFade );
				float temp_output_53_0_g11906 = max( ( _FullGlowDissolveFade * _FullGlowDissolveWidth ) , 0.001 );
				float4 temp_output_1_0_g11906 = staticSwitch3_g11897;
				float4 appendResult3_g11906 = (float4(( ( (_FullGlowDissolveEdgeColor).rgb * ( temp_output_61_0_g11906 - step( temp_output_5_0_g11906 , ( ( _FullGlowDissolveFade * ( 1.01 + temp_output_53_0_g11906 ) ) - temp_output_53_0_g11906 ) ) ) ) + (temp_output_1_0_g11906).rgb ) , ( temp_output_1_0_g11906.a * temp_output_61_0_g11906 )));
				#ifdef _ENABLEFULLGLOWDISSOLVE_ON
				float4 staticSwitch5_g11897 = appendResult3_g11906;
				#else
				float4 staticSwitch5_g11897 = staticSwitch3_g11897;
				#endif
				float4 temp_output_1_0_g11908 = staticSwitch5_g11897;
				float2 temp_output_76_0_g11908 = temp_output_18_0_g11897;
				float linValue16_g11909 = tex2D( _UberNoiseTexture, ( temp_output_76_0_g11908 * _SourceAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11909 = MyCustomExpression16_g11909( linValue16_g11909 );
				float clampResult17_g11908 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_76_0_g11908 ) + ( localMyCustomExpression16_g11909 * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11908 = (float4((temp_output_1_0_g11908).rgb , ( temp_output_1_0_g11908.a * (( _SourceAlphaDissolveInvert )?( ( 1.0 - clampResult17_g11908 ) ):( clampResult17_g11908 )) )));
				#ifdef _ENABLESOURCEALPHADISSOLVE_ON
				float4 staticSwitch8_g11897 = appendResult3_g11908;
				#else
				float4 staticSwitch8_g11897 = staticSwitch5_g11897;
				#endif
				float2 temp_output_90_0_g11904 = temp_output_18_0_g11897;
				float linValue16_g11905 = tex2D( _UberNoiseTexture, ( temp_output_90_0_g11904 * _SourceGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11905 = MyCustomExpression16_g11905( linValue16_g11905 );
				float temp_output_65_0_g11904 = ( distance( _SourceGlowDissolvePosition , temp_output_90_0_g11904 ) + ( localMyCustomExpression16_g11905 * _SourceGlowDissolveNoiseFactor ) );
				float temp_output_75_0_g11904 = step( temp_output_65_0_g11904 , _SourceGlowDissolveFade );
				float temp_output_76_0_g11904 = step( temp_output_65_0_g11904 , ( _SourceGlowDissolveFade - max( _SourceGlowDissolveWidth , 0.001 ) ) );
				float4 temp_output_1_0_g11904 = staticSwitch8_g11897;
				float4 appendResult3_g11904 = (float4(( ( max( ( temp_output_75_0_g11904 - temp_output_76_0_g11904 ) , 0.0 ) * (_SourceGlowDissolveEdgeColor).rgb ) + (temp_output_1_0_g11904).rgb ) , ( temp_output_1_0_g11904.a * (( _SourceGlowDissolveInvert )?( ( 1.0 - temp_output_76_0_g11904 ) ):( temp_output_75_0_g11904 )) )));
				#ifdef _ENABLESOURCEGLOWDISSOLVE_ON
				float4 staticSwitch9_g11897 = appendResult3_g11904;
				#else
				float4 staticSwitch9_g11897 = staticSwitch8_g11897;
				#endif
				float4 temp_output_1_0_g11900 = staticSwitch9_g11897;
				float2 temp_output_161_0_g11900 = temp_output_18_0_g11897;
				float3 rotatedValue136_g11900 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_161_0_g11900 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g11900 = rotatedValue136_g11900;
				float linValue16_g11901 = tex2D( _UberNoiseTexture, ( temp_output_161_0_g11900 * _DirectionalAlphaFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11901 = MyCustomExpression16_g11901( linValue16_g11901 );
				float clampResult154_g11900 = clamp( ( ( break130_g11900.x + break130_g11900.y + _DirectionalAlphaFadeFade + ( localMyCustomExpression16_g11901 * _DirectionalAlphaFadeNoiseFactor ) ) / max( _DirectionalAlphaFadeWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11900 = (float4((temp_output_1_0_g11900).rgb , ( temp_output_1_0_g11900.a * (( _DirectionalAlphaFadeInvert )?( ( 1.0 - clampResult154_g11900 ) ):( clampResult154_g11900 )) )));
				#ifdef _ENABLEDIRECTIONALALPHAFADE_ON
				float4 staticSwitch11_g11897 = appendResult3_g11900;
				#else
				float4 staticSwitch11_g11897 = staticSwitch9_g11897;
				#endif
				float2 temp_output_171_0_g11902 = temp_output_18_0_g11897;
				float3 rotatedValue136_g11902 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_171_0_g11902 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalGlowFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g11902 = rotatedValue136_g11902;
				float linValue16_g11903 = tex2D( _UberNoiseTexture, ( temp_output_171_0_g11902 * _DirectionalGlowFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11903 = MyCustomExpression16_g11903( linValue16_g11903 );
				float temp_output_168_0_g11902 = max( ( ( break130_g11902.x + break130_g11902.y + _DirectionalGlowFadeFade + ( localMyCustomExpression16_g11903 * _DirectionalGlowFadeNoiseFactor ) ) / max( _DirectionalGlowFadeWidth , 0.001 ) ) , 0.0 );
				float temp_output_161_0_g11902 = step( 0.1 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g11902 ) ):( temp_output_168_0_g11902 )) );
				float4 temp_output_1_0_g11902 = staticSwitch11_g11897;
				float clampResult154_g11902 = clamp( temp_output_161_0_g11902 , 0.0 , 1.0 );
				float4 appendResult3_g11902 = (float4(( ( (_DirectionalGlowFadeEdgeColor).rgb * ( temp_output_161_0_g11902 - step( 1.0 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g11902 ) ):( temp_output_168_0_g11902 )) ) ) ) + (temp_output_1_0_g11902).rgb ) , ( temp_output_1_0_g11902.a * clampResult154_g11902 )));
				#ifdef _ENABLEDIRECTIONALGLOWFADE_ON
				float4 staticSwitch15_g11897 = appendResult3_g11902;
				#else
				float4 staticSwitch15_g11897 = staticSwitch11_g11897;
				#endif
				float4 temp_output_1_0_g11910 = staticSwitch15_g11897;
				float2 temp_output_126_0_g11910 = temp_output_18_0_g11897;
				float temp_output_121_0_g11910 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_126_0_g11910 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
				float2 appendResult11_g11911 = (float2(temp_output_121_0_g11910 , temp_output_121_0_g11910));
				float temp_output_17_0_g11911 = length( ( (( ( abs( temp_output_126_0_g11910 ) * _HalftoneTiling ) % float2( 1,1 ) )*2.0 + -1.0) / appendResult11_g11911 ) );
				float clampResult17_g11910 = clamp( saturate( ( ( 1.0 - temp_output_17_0_g11911 ) / fwidth( temp_output_17_0_g11911 ) ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11910 = (float4((temp_output_1_0_g11910).rgb , ( temp_output_1_0_g11910.a * (( _HalftoneInvert )?( ( 1.0 - clampResult17_g11910 ) ):( clampResult17_g11910 )) )));
				#ifdef _ENABLEHALFTONE_ON
				float4 staticSwitch13_g11897 = appendResult3_g11910;
				#else
				float4 staticSwitch13_g11897 = staticSwitch15_g11897;
				#endif
				float3 temp_output_3_0_g11913 = (_AddColorColor).rgb;
				float2 uv_AddColorMask = IN.texcoord.xy * _AddColorMask_ST.xy + _AddColorMask_ST.zw;
				float4 tex2DNode19_g11913 = tex2D( _AddColorMask, uv_AddColorMask );
				#ifdef _ADDCOLORMASKTOGGLE_ON
				float3 staticSwitch16_g11913 = ( temp_output_3_0_g11913 * ( (tex2DNode19_g11913).rgb * tex2DNode19_g11913.a ) );
				#else
				float3 staticSwitch16_g11913 = temp_output_3_0_g11913;
				#endif
				float4 temp_output_1_0_g11913 = staticSwitch13_g11897;
				float4 break2_g11915 = temp_output_1_0_g11913;
				#ifdef _ADDCOLORCONTRASTTOGGLE_ON
				float3 staticSwitch17_g11913 = ( staticSwitch16_g11913 * pow( max( ( ( break2_g11915.x + break2_g11915.x + break2_g11915.y + break2_g11915.y + break2_g11915.y + break2_g11915.z ) / 6.0 ) , 0.0001 ) , max( _AddColorContrast , 0.0001 ) ) );
				#else
				float3 staticSwitch17_g11913 = staticSwitch16_g11913;
				#endif
				float4 appendResult6_g11913 = (float4(( ( staticSwitch17_g11913 * _AddColorFade ) + (temp_output_1_0_g11913).rgb ) , temp_output_1_0_g11913.a));
				#ifdef _ENABLEADDCOLOR_ON
				float4 staticSwitch5_g11912 = appendResult6_g11913;
				#else
				float4 staticSwitch5_g11912 = staticSwitch13_g11897;
				#endif
				float4 temp_output_1_0_g11916 = staticSwitch5_g11912;
				float3 lerpResult4_g11916 = lerp( (temp_output_1_0_g11916).rgb , (_AlphaTintColor).rgb , ( ( 1.0 - temp_output_1_0_g11916.a ) * step( _AlphaTintMinAlpha , temp_output_1_0_g11916.a ) * _AlphaTintFade ));
				float4 appendResult13_g11916 = (float4(lerpResult4_g11916 , temp_output_1_0_g11916.a));
				#ifdef _ENABLEALPHATINT_ON
				float4 staticSwitch11_g11912 = appendResult13_g11916;
				#else
				float4 staticSwitch11_g11912 = staticSwitch5_g11912;
				#endif
				float4 temp_output_1_0_g11917 = staticSwitch11_g11912;
				float3 temp_output_6_0_g11917 = (_StrongTintTint).rgb;
				float2 uv_StrongTintMask = IN.texcoord.xy * _StrongTintMask_ST.xy + _StrongTintMask_ST.zw;
				float4 tex2DNode23_g11917 = tex2D( _StrongTintMask, uv_StrongTintMask );
				#ifdef _STRONGTINTMASKTOGGLE_ON
				float3 staticSwitch21_g11917 = ( temp_output_6_0_g11917 * ( (tex2DNode23_g11917).rgb * tex2DNode23_g11917.a ) );
				#else
				float3 staticSwitch21_g11917 = temp_output_6_0_g11917;
				#endif
				float4 break2_g11919 = temp_output_1_0_g11917;
				#ifdef _STRONGTINTCONTRASTTOGGLE_ON
				float3 staticSwitch22_g11917 = ( pow( max( ( ( break2_g11919.x + break2_g11919.x + break2_g11919.y + break2_g11919.y + break2_g11919.y + break2_g11919.z ) / 6.0 ) , 0.0001 ) , max( _StrongTintContrast , 0.0001 ) ) * staticSwitch21_g11917 );
				#else
				float3 staticSwitch22_g11917 = staticSwitch21_g11917;
				#endif
				float3 lerpResult7_g11917 = lerp( (temp_output_1_0_g11917).rgb , staticSwitch22_g11917 , _StrongTintFade);
				float4 appendResult9_g11917 = (float4(lerpResult7_g11917 , (temp_output_1_0_g11917).a));
				#ifdef _ENABLESTRONGTINT_ON
				float4 staticSwitch7_g11912 = appendResult9_g11917;
				#else
				float4 staticSwitch7_g11912 = staticSwitch11_g11912;
				#endif
				float4 temp_output_2_0_g11920 = staticSwitch7_g11912;
				float4 break4_g11922 = temp_output_2_0_g11920;
				float3 appendResult5_g11922 = (float3(break4_g11922.r , break4_g11922.g , break4_g11922.b));
				float2 appendResult10_g11921 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 appendResult2_g11921 = (float2(1.0 , ( _MainTex_TexelSize.z / _MainTex_TexelSize.w )));
				#ifdef _RESIZABLETEXTURE_ON
				float2 staticSwitch9_g11921 = appendResult2_g11921;
				#else
				float2 staticSwitch9_g11921 = ( float2( 100,100 ) / appendResult10_g11921 );
				#endif
				float4 appendResult85_g11920 = (float4(_ShadowColor.r , _ShadowColor.g , _ShadowColor.b , ( _ShadowFade * tex2D( _MainTex, ( finalUV146 - ( staticSwitch9_g11921 * _ShadowOffset ) ) ).a )));
				float4 break6_g11922 = appendResult85_g11920;
				float3 appendResult7_g11922 = (float3(break6_g11922.r , break6_g11922.g , break6_g11922.b));
				float temp_output_11_0_g11922 = ( ( 1.0 - break4_g11922.a ) * break6_g11922.a );
				float temp_output_32_0_g11922 = ( break4_g11922.a + temp_output_11_0_g11922 );
				float4 appendResult18_g11922 = (float4(( ( ( appendResult5_g11922 * break4_g11922.a ) + ( appendResult7_g11922 * temp_output_11_0_g11922 ) ) * ( 1.0 / max( temp_output_32_0_g11922 , 0.01 ) ) ) , temp_output_32_0_g11922));
				#ifdef _ENABLESHADOW_ON
				float4 staticSwitch82_g11920 = appendResult18_g11922;
				#else
				float4 staticSwitch82_g11920 = temp_output_2_0_g11920;
				#endif
				float4 break4_g11923 = staticSwitch82_g11920;
				#ifdef _ENABLECUSTOMFADE_ON
				float staticSwitch8_g11767 = 1.0;
				#else
				float staticSwitch8_g11767 = IN.color.a;
				#endif
				#ifdef _ENABLESMOKE_ON
				float staticSwitch9_g11767 = 1.0;
				#else
				float staticSwitch9_g11767 = staticSwitch8_g11767;
				#endif
				float customVertexAlpha193 = staticSwitch9_g11767;
				float4 appendResult5_g11923 = (float4(break4_g11923.r , break4_g11923.g , break4_g11923.b , ( break4_g11923.a * customVertexAlpha193 )));
				float4 temp_output_344_0 = appendResult5_g11923;
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;365;-372.9774,-3275.82;Inherit;False;_UberInteractive;542;;11663;f8a4d7008519ad249b29e4a9381f963f;0;2;9;FLOAT;0;False;3;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;79;-47.4363,-2946.944;Inherit;False;_FullDistortion;474;;11665;62960fe27c1c398408207bb462ffd10e;0;3;195;FLOAT2;0,0;False;160;FLOAT2;0,0;False;194;SAMPLER2D;;False;2;FLOAT2;174;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;81;747.3577,-2918.135;Inherit;False;_DirectionalDistortion;462;;11668;30e6ac39427ee11419083602d572972f;0;3;182;FLOAT2;0,0;False;160;FLOAT2;0,0;False;181;SAMPLER2D;;False;2;FLOAT2;174;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;102;919.0109,-667.4209;Inherit;False;_GlitchPre;222;;11671;b8ad29d751d87bd4d9cbf14898be6163;0;3;19;FLOAT;0;False;18;FLOAT2;0,0;False;16;SAMPLER2D;;False;2;FLOAT;15;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;471;-1990.589,-315.832;Inherit;False;_UberSample;580;;11734;1028d755b36e2b04da25c3b882a2e2ec;0;2;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;292;5091.561,1459.408;Inherit;False;ShaderMasker;-1;;11754;3d25b55dbfdd24f48b9bd371bdde0e97;0;2;1;FLOAT;0;False;2;SAMPLER2D;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;341;2716.61,1541.034;Inherit;False;ShaderTime;25;;11759;06a15e67904f217499045f361bad56e7;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;439;3389.449,1182.896;Inherit;False;ShaderSpace;9;;11760;be729ef05db9c224caec82a3516038dc;0;2;61;FLOAT2;0,0;False;3;SAMPLER2D;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;1839.482,-2552.931;Inherit;False;_HologramUV;213;;11761;7c71b1b031ffcbe48805e17b94671163;0;7;77;FLOAT;0;False;55;FLOAT;0;False;76;SAMPLER2D;;False;37;FLOAT2;0,0;False;39;SAMPLER2D;;False;81;FLOAT;0;False;79;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;103;2715.721,-2556.586;Inherit;False;_GlitchUV;234;;11765;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;343;-737.796,35.8288;Inherit;False;_UberCustomAlpha;591;;11767;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;FLOAT;12;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;239;-404.7228,-125.1053;Inherit;False;_UberGenerated;565;;11772;52defa3f7cca25740a6a77f065edb382;0;4;10;FLOAT;0;False;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;484;3382.41,-2373.518;Inherit;False;_UberTransformUV;479;;11776;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;378;5475.994,-2043.135;Inherit;False;Remap2D;-1;;11788;f79f855c0a5c94649b58f3d8127375ae;0;5;13;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;1,1;False;5;FLOAT2;0,0;False;6;FLOAT2;1,1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;361;-136.8644,-329.1863;Inherit;False;_UberColor;66;;11789;db48f560e502b78409f7fbe481a93597;0;6;39;FLOAT;0;False;40;FLOAT2;0,0;False;1;FLOAT2;0,0;False;24;SAMPLER2D;0;False;3;COLOR;0,0,0,0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;51;183.7499,-168.0946;Inherit;False;_Hologram;206;;11831;76082a965d84d0e4da33b2cff51b3691;0;5;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;43;FLOAT;0;False;44;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;104;973.7388,-316.5438;Inherit;False;_Glitch;228;;11834;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;470;6618.802,-2035.91;Inherit;False;_PixelArtUV_2;-1;;11838;4b65626ba2313ca40a96813b19044794;0;4;21;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;473;1656.25,-345.9998;Inherit;False;_UberEffect;239;;11839;93c7a07f758a0814998210619e8ad1cb;0;4;40;FLOAT;0;False;41;FLOAT2;0,0;False;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;78;2104.106,-267.8359;Inherit;False;AlphaMultiply;-1;;11895;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;76;3014.405,-219.2272;Inherit;False;AlphaMultiply;-1;;11896;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;248;3912.165,-179.9706;Inherit;False;_UberFading;402;;11897;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;478;4200.417,-206.2577;Inherit;False;_UberColorFinal;37;;11912;6ac57aba23ea6404ba71b6806ea93971;0;3;14;FLOAT2;0,0;False;15;SAMPLER2D;;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;344;4548.086,-90.46628;Inherit;False;AlphaMultiply;-1;;11923;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;199;4171.966,521.7499;Inherit;False;_Squish;560;;11924;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;424;4759.72,401.6135;Inherit;False;_UberTransformOffset;526;;11927;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;340;6010.595,-19.64009;Inherit;False;BakingHandler;6;;11931;f63dfe0dc7c747c43b593d357b168fa0;0;1;7;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=8349162D796F285E625DAC2D3ADE5FC5CF16A7D2