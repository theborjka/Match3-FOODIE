...
Shader "Sprite Shaders Ultimate/Additive GUI SSU"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            float MyCustomExpression16_g13125( float linValue )
            {
            ...
            float MyCustomExpression16_g13123( float linValue )
            {
            	#ifdef UNITY_COLORSPACE_GAMMA
            	return linValue;
            	#else
            ...
            v2f vert(appdata_t v )
            {
                ...
                float4 tex2DNode3_g13126 = tex2Dlod( _FadingMask, float4( uv_FadingMask, 0, 0.0) );
                float temp_output_4_0_g13124 = max( _FadingWidth , 0.001 );
                ...
                float linValue16_g13125 = tex2Dlod( _UberNoiseTexture, float4( ( shaderPosition235 * _FadingNoiseScale ), 0, 0.0) ).r;
                float localMyCustomExpression16_g13125 = MyCustomExpression16_g13125( linValue16_g13125 );
                float clampResult14_g13124 = clamp( ( ( ( _FadingFade * ( 1.0 + temp_output_4_0_g13124 ) ) - localMyCustomExpression16_g13125 ) / temp_output_4_0_g13124 ) , 0.0 , 1.0 );
                float2 temp_output_27_0_g13122 = shaderPosition235;
                float linValue16_g13123 = tex2Dlod( _UberNoiseTexture, float4( ( temp_output_27_0_g13122 * _FadingNoiseScale ), 0, 0.0) ).r;
                float localMyCustomExpression16_g13123 = MyCustomExpression16_g13123( linValue16_g13123 );
                float clampResult3_g13122 = clamp( ( ( _FadingFade - ( distance( _FadingPosition , temp_output_27_0_g13122 ) + ( localMyCustomExpression16_g13123 * _FadingNoiseFactor ) ) ) / max( _FadingWidth , 0.001 ) ) , 0.0 , 1.0 );
                ...
                float staticSwitch139 = ( _FadingFade * ( tex2DNode3_g13126.r * tex2DNode3_g13126.a ) );
                #elif defined( _SHADERFADING_DISSOLVE )
                float staticSwitch139 = clampResult14_g13124;
                #elif defined( _SHADERFADING_SPREAD )
                float staticSwitch139 = clampResult3_g13122;
                #else
                float staticSwitch139 = _FadingFade;
                #endif
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float4 tex2DNode3_g13126 = tex2D( _FadingMask, uv_FadingMask );
                float temp_output_4_0_g13124 = max( _FadingWidth , 0.001 );
                float linValue16_g13125 = tex2D( _UberNoiseTexture, ( shaderPosition235 * _FadingNoiseScale ) ).r;
                float localMyCustomExpression16_g13125 = MyCustomExpression16_g13125( linValue16_g13125 );
                float clampResult14_g13124 = clamp( ( ( ( _FadingFade * ( 1.0 + temp_output_4_0_g13124 ) ) - localMyCustomExpression16_g13125 ) / temp_output_4_0_g13124 ) , 0.0 , 1.0 );
                float2 temp_output_27_0_g13122 = shaderPosition235;
                float linValue16_g13123 = tex2D( _UberNoiseTexture, ( temp_output_27_0_g13122 * _FadingNoiseScale ) ).r;
                float localMyCustomExpression16_g13123 = MyCustomExpression16_g13123( linValue16_g13123 );
                float clampResult3_g13122 = clamp( ( ( _FadingFade - ( distance( _FadingPosition , temp_output_27_0_g13122 ) + ( localMyCustomExpression16_g13123 * _FadingNoiseFactor ) ) ) / max( _FadingWidth , 0.001 ) ) , 0.0 , 1.0 );
                #if defined( _SHADERFADING_NONE )
                float staticSwitch139 = _FadingFade;
                ...
                float4 appendResult8_g13121 = (float4(( (temp_output_1_0_g13121).rgb * (UIVertexColor501).rgb ) , temp_output_1_0_g13121.a));
                ...
                float4 appendResult8_g13293 = (float4(( (temp_output_1_0_g13293).rgb * (UIVertexColor501).rgb ) , temp_output_1_0_g13293.a));
                #ifdef _VERTEXTINTFIRST_ON
                ...
                float4 appendResult8_g13294 = (float4(( (temp_output_1_0_g13294).rgb * (UIVertexColor501).rgb ) , temp_output_1_0_g13294.a));
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;231;4899.456,2440.854;Inherit;False;_UberSpreadFade;-1;;13122;777ca8ab10170fb48b24b7cd1c44f075;0;7;27;FLOAT2;0,0;False;22;FLOAT;0;False;18;SAMPLER2D;0;False;25;FLOAT2;0,0;False;23;FLOAT2;0,0;False;21;FLOAT;0;False;26;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;223;4905.316,1828.167;Inherit;False;_UberDissolveFade;-1;;13124;cb957eb9b67f4f243aa8ba0547208263;0;5;21;FLOAT2;0,0;False;1;FLOAT;0;False;16;SAMPLER2D;0;False;18;FLOAT2;0,0;False;20;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;292;5091.561,1459.408;Inherit;False;ShaderMasker;-1;;13126;3d25b55dbfdd24f48b9bd371bdde0e97;0;2;1;FLOAT;0;False;2;SAMPLER2D;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;1839.482,-2552.931;Inherit;False;_HologramUV;219;;13129;7c71b1b031ffcbe48805e17b94671163;0;7;77;FLOAT;0;False;55;FLOAT;0;False;76;SAMPLER2D;;False;37;FLOAT2;0,0;False;39;SAMPLER2D;;False;81;FLOAT;0;False;79;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;51;183.7499,-168.0946;Inherit;False;_Hologram;212;;13199;76082a965d84d0e4da33b2cff51b3691;0;5;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;43;FLOAT;0;False;44;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;504;4992,80;Inherit;False;ColorMultiply;-1;;13294;1f51da7edd80c06488c56d28bc096dec;0;2;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=86B762D0FCACDE896E92967354AF4E2349154F9B